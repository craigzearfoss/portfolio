...
class JobTask extends Model
{
     ...
     */
    const array SEARCH_COLUMNS = [ 'id', 'owner_id', 'job_id', 'featured', 'summary', 'notes', 'link', 'link_name',
    ...
    const array SORT_FIELDS = [
        'admin' => [ 'company_name', 'is_disabled', 'favorite_count', 'summary', 'is_public', ],
        'guest' => [ 'company_name', 'summary', ],
    ];

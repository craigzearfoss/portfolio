...
class Resource extends Model
{
    ...
    const array SORT_FIELDS = [
        'admin' => [ 'admin', 'class', 'database_id', 'database_database', 'database_name', 'database_tag',
            'is_disabled', 'favorite_count', 'guest', 'icon', 'menu', 'menu_level', 'name', 'is_public', 'sequence',
            'table', 'title', 'user' ],

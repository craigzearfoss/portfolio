...
class AddPortfolio extends Command
{
    ...
    protected function insertPortfolioJobTasks(): void
    {
        ...
        $data = [
            ['job_id' => $this->jobId[1], 'summary' => 'Upgraded and enhanced legacy system to use modern CodeIgniter 4 and Vue.js frameworks.', 'sequence' => 0],
            ['job_id' => $this->jobId[1], 'summary' => 'Led the implementation of an RBAC system, enhancing security protocols and user management.', 'sequence' => 1],
            ['job_id' => $this->jobId[1], 'summary' => 'Designed and created a custom ticket authoring interface using Vue.js.', 'sequence' => 2],
            ['job_id' => $this->jobId[1], 'summary' => 'Upgraded site to PHP 8.4 and MySQL 8.2.', 'sequence' => 3],
            ['job_id' => $this->jobId[2], 'summary' => 'Created custom Elasticsearch queries to gather retailer listing data for 3M products to ensure accuracy.', 'sequence' => 0],
            ['job_id' => $this->jobId[3], 'summary' => 'Automated PDF booklet creation from online state-wide interactive student exams.', 'sequence' => 0],
            ['job_id' => $this->jobId[3], 'summary' => 'Implemented a custom queuing system to control the PDF booklet system process.', 'sequence' => 1],
            ['job_id' => $this->jobId[3], 'summary' => 'Created a booklet previewer to allow graphic designers to make modifications to individual test items.', 'sequence' => 2],
            ['job_id' => $this->jobId[3], 'summary' => 'Developed interactive test items to enhance user engagement and improve assessment accuracy.', 'sequence' => 3],
            ['job_id' => $this->jobId[4], 'summary' => 'Performed SEO optimization, A/B testing, traffic analysis, and billing audits.', 'sequence' => 0],
            ['job_id' => $this->jobId[4], 'summary' => 'Enhanced content management efficiency by developing robust administrative applications.', 'sequence' => 1],
            ['job_id' => $this->jobId[5], 'summary' => 'Created online assessments and performed complex statistical analysis of result data.', 'sequence' => 0],
            ['job_id' => $this->jobId[5], 'summary' => 'Generated PDF reports with graphic data analysis for individual participants.', 'sequence' => 1],
            ['job_id' => $this->jobId[7], 'summary' => 'Designed and created an in-house website for managing software applications.', 'sequence' => 0],
            ['job_id' => $this->jobId[7], 'summary' => 'Performed software testing, hardware upgrades, and pc maintenance.', 'sequence' => 1],
            ['job_id' => $this->jobId[8], 'summary' => 'Created an administrative area with built-in permissions and advanced search features.', 'sequence' => 0],
            ['job_id' => $this->jobId[8], 'summary' => 'Made site fully customizable to allow users to control what information is publicly displayed.', 'sequence' => 1],
            ['job_id' => $this->jobId[8], 'summary' => 'Optimized database queries to reduce load times and improve site performance.', 'sequence' => 2],
            ['job_id' => $this->jobId[8], 'summary' => 'The code repository is at https://github.com/craigzearfoss/portfolio .', 'sequence' => 3],

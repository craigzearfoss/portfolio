...
class AddPortfolio extends Command
{
    ...
    protected function insertPortfolioCourses(): void
    {
        ...
        $data = [
            ...
            [   //@TODO: The certificate didn't download
    ...
    protected function insertPortfolioEducations(): void
    {
        ...
        $data = [
            [
                ...
                'enrollment_date'    => '1982-08-01',
                'graduated'          => 1,
                'graduation_date'    => '1988-01-01',
    ...
    protected function insertPortfolioJobs(): void
    {
        ...
        $this->jobId = [];
        $maxId = $jobModel->withoutGlobalScope(AdminPublicScope::class)->max('id');
        for ($i=1; $i<=8; $i++) {
            $this->jobId[$i] = ++$maxId;
        }
        ...
        $data = [
            ...
            [
                ...
                'featured'               => 0,
                'summary'                => 'Modernized and added new features to an authoring and delivery system for state-wide student assessments.',
            ...
            [
                ...
                'featured'               => 0,
                'summary'                => 'Created and maintained high-traffic multimedia member websites and public tours.',
            ...
            [
                ...
                'featured'               => 0,
                'summary'                => 'Designed and implemented web-based leadership assessments for multiple clients.',
            ...
            [
                ...
                'featured'               => 0,
                'summary'                => 'Converted a Linux-based real estate application to Windows for remote use by real estate agents.',
            ...
            [
                ...
                'featured'               => 0,
                'summary'                => 'Created an automated build process for Windows OEM pre-installation software for all Lenovo PCs.',
            ...
            [
                ...
                'role'                   => 'Senior Software Designer and Developer',
                'slug'                   => 'self-employed-(senior-software-designer-and-developer)',
                'featured'               => 1,
                'summary'                => 'Designed, created, and deployed https://demo.zearfoss.com, a multi-user website for managing careers and job searches.',
                'start_date'             => '2026-01-01',
                'end_date'               => null,
                'job_employment_type_id' => 3,
                'job_location_type_id'   => 3,
                'city'                   => 'York',
                'state_id'               => 39,
                'country_id'             => 237,
                'latitude'               => 39.9697392,
                'longitude'              => -76.8126842,
                'thumbnail'              => null,
                'logo'                   => null,
                'logo_small'             => null,
                'is_public'              => 1,
    ...
    protected function insertPortfolioJobSkills(): void
    {
        ...
        $data = [
            [ 'job_id' => $this->jobId[1],  'name' => 'PHP',                          'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[1],  'name' => 'CodeIgniter 4',                'dictionary_category_id' => 11,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[1],  'name' => 'MySQL',                        'dictionary_category_id' => 8,    'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[1],  'name' => 'MariaDB',                      'dictionary_category_id' => 8,    'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[1],  'name' => 'Vue.js',                       'dictionary_category_id' => 11,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[1],  'name' => 'JavaScript ES6',               'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[1],  'name' => 'jQuery',                       'dictionary_category_id' => 13,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[1],  'name' => 'CSS3',                         'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[1],  'name' => 'Git',                          'dictionary_category_id' => 34,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[1],  'name' => 'Software Development',         'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[1],  'name' => 'Internet Design',              'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[1],  'name' => 'Server Side Programming',      'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[2],  'name' => 'PHP',                          'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[2],  'name' => 'Vue.js',                       'dictionary_category_id' => 11,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[2],  'name' => 'MySQL',                        'dictionary_category_id' => 8,    'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[2],  'name' => 'Elasticsearch',                'dictionary_category_id' => 8,    'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[2],  'name' => 'JavaScript ES6',               'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[2],  'name' => 'CSS3',                         'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[2],  'name' => 'Git',                          'dictionary_category_id' => 34,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[2],  'name' => 'Software Design',              'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[2],  'name' => 'Software Development',         'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[2],  'name' => 'Server Side Programming',      'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[3],  'name' => 'PHP',                          'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[3],  'name' => 'Laravel',                      'dictionary_category_id' => 11,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[3],  'name' => 'PostgreSQL',                   'dictionary_category_id' => 8,    'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[3],  'name' => 'JavaScript ES6',               'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[3],  'name' => 'jQuery',                       'dictionary_category_id' => 13,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[3],  'name' => 'XML',                          'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[3],  'name' => 'HTML5',                        'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[3],  'name' => 'Git',                          'dictionary_category_id' => 34,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[3],  'name' => 'JIRA',                         'dictionary_category_id' => 28,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[3],  'name' => 'Software Design',              'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[3],  'name' => 'Software Development',         'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[3],  'name' => 'Server Side Programming',      'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'PHP',                          'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'MySQL',                        'dictionary_category_id' => 8,    'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'JavaScript ES6',               'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'jQuery',                       'dictionary_category_id' => 13,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'Ubuntu',                       'dictionary_category_id' => 17,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'Apache2',                      'dictionary_category_id' => 26,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'Nginx',                        'dictionary_category_id' => 26,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'CSS',                          'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'Git',                          'dictionary_category_id' => 34,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'JIRA',                         'dictionary_category_id' => 28,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'Symfony2',                     'dictionary_category_id' => 11,   'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'Zend Framework',               'dictionary_category_id' => 11,   'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'Software Development',         'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'Internet Design',              'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[4],  'name' => 'Server Side Programming',      'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[5],  'name' => 'PHP',                          'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[5],  'name' => 'MySQL',                        'dictionary_category_id' => 8,    'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[5],  'name' => 'JavaScript',                   'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[5],  'name' => 'jQuery',                       'dictionary_category_id' => 13,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[5],  'name' => 'Apache2',                      'dictionary_category_id' => 26,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[5],  'name' => 'PDFLib',                       'dictionary_category_id' => 13,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[5],  'name' => 'Software Development',         'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[5],  'name' => 'Software Design',              'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[5],  'name' => 'Server Side Programming',      'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[6],  'name' => 'PHP',                          'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[6],  'name' => 'MySQL',                        'dictionary_category_id' => 8,    'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[6],  'name' => 'Oracle',                       'dictionary_category_id' => 8,    'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[6],  'name' => 'JavaScript',                   'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[6],  'name' => 'Windows',                      'dictionary_category_id' => 17,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[6],  'name' => 'Linux',                        'dictionary_category_id' => 17,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[6],  'name' => 'CSS',                          'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[6],  'name' => 'SQL',                          'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[6],  'name' => 'Software Development',         'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[7],  'name' => 'Rexx',                         'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[7],  'name' => 'Visual Basic',                 'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[7],  'name' => 'DOS',                          'dictionary_category_id' => 17,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[7],  'name' => 'OS/2',                         'dictionary_category_id' => 17,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[7],  'name' => 'Windows',                      'dictionary_category_id' => 17,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[7],  'name' => 'Windows NT',                   'dictionary_category_id' => 17,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[7],  'name' => 'JavaScript',                   'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[7],  'name' => 'Lotus Note',                   'dictionary_category_id' => 28,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[7],  'name' => 'Software Development',         'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'PHP',                          'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'Laravel 12',                   'dictionary_category_id' => 11,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'MySQL',                        'dictionary_category_id' => 8,    'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'JavaScript ES6',               'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'CSS3',                         'dictionary_category_id' => 12,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'Ubuntu',                       'dictionary_category_id' => 17,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'Nginx',                        'dictionary_category_id' => 26,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'Amazon Web Services (AWS)',    'dictionary_category_id' => 17,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'Amazon EC2',                   'dictionary_category_id' => 27,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'Bulma CSS framework',          'dictionary_category_id' => 11,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'HTML5',                        'dictionary_category_id' => 11,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'Git',                          'dictionary_category_id' => 34,   'dictionary_term_id' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'Software Development',         'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'Database Design',              'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'Internet Design',              'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
            [ 'job_id' => $this->jobId[8],  'name' => 'Server Side Programming',      'dictionary_category_id' => null, 'dictionary_term_id' => null, 'is_public' => 0 ],
    ...
    protected function insertPortfolioJobTasks(): void
    {
        ...
        $data = [
            ['job_id' => $this->jobId[1], 'summary' => 'Upgraded and enhanced legacy system to use modern CodeIgniter 4 and Vue.js frameworks.', 'is_public' => 1, 'sequence' => 0],
            ['job_id' => $this->jobId[1], 'summary' => 'Led the implementation of an RBAC system, enhancing security protocols and user management.', 'is_public' => 1, 'sequence' => 1],
            ['job_id' => $this->jobId[1], 'summary' => 'Designed and created a custom ticket authoring interface using Vue.js.', 'is_public' => 1, 'sequence' => 2],
            ['job_id' => $this->jobId[1], 'summary' => 'Upgraded site to PHP 8.4 and MySQL 8.2.', 'is_public' => 1, 'sequence' => 3],
            ['job_id' => $this->jobId[2], 'summary' => 'Created custom Elasticsearch queries to gather retailer listing data for 3M products to ensure accuracy.', 'is_public' => 1, 'sequence' => 0],
            ['job_id' => $this->jobId[3], 'summary' => 'Automated PDF booklet creation from online state-wide interactive student exams.', 'is_public' => 1, 'sequence' => 0],
            ['job_id' => $this->jobId[3], 'summary' => 'Implemented a custom queuing system to control the PDF booklet system process.', 'is_public' => 1, 'sequence' => 1],
            ['job_id' => $this->jobId[3], 'summary' => 'Created a booklet previewer to allow graphic designers to make modifications to individual test items.', 'is_public' => 1, 'sequence' => 2],
            ['job_id' => $this->jobId[3], 'summary' => 'Developed interactive test items to enhance user engagement and improve assessment accuracy.', 'is_public' => 1, 'sequence' => 3],
            ['job_id' => $this->jobId[4], 'summary' => 'Performed SEO optimization, A/B testing, traffic analysis, and billing audits.', 'is_public' => 1, 'sequence' => 0],
            ['job_id' => $this->jobId[4], 'summary' => 'Enhanced content management efficiency by developing robust administrative applications.', 'is_public' => 1, 'sequence' => 1],
            ['job_id' => $this->jobId[5], 'summary' => 'Created online assessments and performed complex statistical analysis of result data.', 'is_public' => 1, 'sequence' => 0],
            ['job_id' => $this->jobId[5], 'summary' => 'Generated PDF reports with graphic data analysis for individual participants.', 'is_public' => 1, 'sequence' => 1],
            ['job_id' => $this->jobId[7], 'summary' => 'Designed and created an in-house website for managing software applications.', 'is_public' => 1, 'sequence' => 0],
            ['job_id' => $this->jobId[7], 'summary' => 'Performed software testing, hardware upgrades, and pc maintenance.', 'is_public' => 1, 'sequence' => 1],
            ['job_id' => $this->jobId[8], 'summary' => 'Created an administrative area with built-in permissions and advanced search features.', 'is_public' => 1, 'sequence' => 0],
            ['job_id' => $this->jobId[8], 'summary' => 'Made site fully customizable to allow users to control what information is publicly displayed.', 'is_public' => 1, 'sequence' => 1],
            ['job_id' => $this->jobId[8], 'summary' => 'Optimized database queries to reduce load times and improve site performance.', 'is_public' => 1, 'sequence' => 2],
            ['job_id' => $this->jobId[8], 'summary' => 'The code repository is at https://github.com/craigzearfoss/portfolio .', 'is_public' => 1, 'sequence' => 3],
            //[ 'job_id' => $this->jobId[x], 'summary' => '', 'is_public' => 1, 'sequence' => 0 ],
        ];
    ...
    protected function insertPortfolioMusic(): void
    {
        ...
        $id = [];
        $maxId = $musicModel->withoutGlobalScope(AdminPublicScope::class)->max('id');
        for ($i=1; $i<=36; $i++) {
            $id[$i] = ++$maxId;
        }
...
EOD,
    ...
    protected function insertPortfolioSkills(): void
    {
        ...
        $data = [
            ...
            [ 'name' => 'jQuery',            'slug' => 'jquery',            'version' => null, 'type_id' => 1, 'dictionary_category_id' => 13,  'featured' => 0, 'level' => 10, 'years' => 18,  'start_year' => 2006, 'end_year' => null, 'is_public' => 1 ],
            ...
            [ 'name' => 'DOS',               'slug' => 'dos',               'version' => null, 'type_id' => 1, 'dictionary_category_id' => 17,  'featured' => 0, 'level' => 6,  'years' => 5,   'start_year' => 2000, 'end_year' => null, 'is_public' => 1 ],
            ...
            [ 'name' => 'JIRA',              'slug' => 'jira',              'version' => null, 'type_id' => 1, 'dictionary_category_id' => 28,  'featured' => 0, 'level' => 7,  'years' => 7,   'start_year' => 2011, 'end_year' => 2019, 'is_public' => 1 ],
            ...
            [ 'name' => 'Twitter Bootstrap', 'slug' => 'twitter-bootstrap', 'version' => null, 'type_id' => 1, 'dictionary_category_id' => 13,  'featured' => 0, 'level' => 7,  'years' => 9,   'start_year' => 2016, 'end_year' => null, 'is_public' => 1 ],
            ...
            [ 'name' => 'REST',              'slug' => 'rest',              'version' => null, 'type_id' => 1, 'dictionary_category_id' => 23,  'featured' => 0, 'level' => 9,  'years' => 9,   'start_year' => 2016, 'end_year' => null, 'is_public' => 1 ],
            ...
            [ 'name' => 'Blade',             'slug' => 'blade',             'version' => null, 'type_id' => 1, 'dictionary_category_id' => 12,  'featured' => 0, 'level' => 10, 'years' => null, 'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'API',               'slug' => 'api',               'version' => null, 'type_id' => 1, 'dictionary_category_id' => 1,   'featured' => 0, 'level' => 8,  'years' => null, 'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'SQL Injection',     'slug' => 'sql-injection',     'version' => null, 'type_id' => 1, 'dictionary_category_id' => 1,   'featured' => 0, 'level' => 10, 'years' => null, 'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'CSRF',              'slug' => 'csrf',              'version' => null, 'type_id' => 1, 'dictionary_category_id' => 1,   'featured' => 0, 'level' => 10, 'years' => null, 'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'JS frameworks',     'slug' => 'js-frameworks',     'version' => null, 'type_id' => 1, 'dictionary_category_id' => 12,   'featured' => 0, 'level' => 8,  'years' => null, 'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
    ...
    protected function insertPortfolioAntiSkills(): void
    {
        ...
        $data = [
            [ 'name' => 'Java',                  'slug' => 'java',                  'version' => null, 'type_id' => 1, 'dictionary_category_id' => 12,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => '.net',                  'slug' => 'net',                   'version' => null, 'type_id' => 1, 'dictionary_category_id' => 12,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'TypeScript',            'slug' => 'typescript',            'version' => null, 'type_id' => 1, 'dictionary_category_id' => 12,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Golang',                'slug' => 'golang',                'version' => null, 'type_id' => 1, 'dictionary_category_id' => 12,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Python',                'slug' => 'python',                'version' => null, 'type_id' => 1, 'dictionary_category_id' => 12,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Angular',               'slug' => 'angular',               'version' => null, 'type_id' => 1, 'dictionary_category_id' => 11,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Ruby on Rails',         'slug' => 'ruby-on-rails',         'version' => null, 'type_id' => 1, 'dictionary_category_id' => 12,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'DevOp',                 'slug' => 'devop',                 'version' => null, 'type_id' => 1, 'dictionary_category_id' => 9,   'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Azure',                 'slug' => 'azure',                 'version' => null, 'type_id' => 1, 'dictionary_category_id' => 19,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Google Cloud',          'slug' => 'google-cloud',          'version' => null, 'type_id' => 1, 'dictionary_category_id' => 19,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Magento',               'slug' => 'magneto',               'version' => null, 'type_id' => 1, 'dictionary_category_id' => 37,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'WordPress',             'slug' => 'wordpress',             'version' => null, 'type_id' => 1, 'dictionary_category_id' => 37,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'SalesForce',            'slug' => 'salesforce',            'version' => null, 'type_id' => 1, 'dictionary_category_id' => 19,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Tailwind',              'slug' => 'tailwind',              'version' => null, 'type_id' => 1, 'dictionary_category_id' => 11,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Alpine',                'slug' => 'alpine',                'version' => null, 'type_id' => 1, 'dictionary_category_id' => 34,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Livewire',              'slug' => 'livewire',              'version' => null, 'type_id' => 1, 'dictionary_category_id' => 11,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Oracle',                'slug' => 'oracle',                'version' => null, 'type_id' => 1, 'dictionary_category_id' => 8,   'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Microsoft Server',      'slug' => 'microsoft-server',      'version' => null, 'type_id' => 1, 'dictionary_category_id' => 27,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'NoSQL',                 'slug' => 'nosql',                 'version' => null, 'type_id' => 1, 'dictionary_category_id' => 8,   'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Lambda',                'slug' => 'lambda',                'version' => null, 'type_id' => 1, 'dictionary_category_id' => 27,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'CloudFront',            'slug' => 'cloudfront',            'version' => null, 'type_id' => 1, 'dictionary_category_id' => 27,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'RedShift',              'slug' => 'redshift',              'version' => null, 'type_id' => 1, 'dictionary_category_id' => 8,   'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'WebSocket',             'slug' => 'websocket',             'version' => null, 'type_id' => 1, 'dictionary_category_id' => 23,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Node.js',               'slug' => 'node-js',               'version' => null, 'type_id' => 1, 'dictionary_category_id' => 26,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Webpack',               'slug' => 'webpack',               'version' => null, 'type_id' => 1, 'dictionary_category_id' => 38,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Babel',                 'slug' => 'babel',                 'version' => null, 'type_id' => 1, 'dictionary_category_id' => 38,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Terraform',             'slug' => 'terraform',             'version' => null, 'type_id' => 1, 'dictionary_category_id' => 19,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Kubernetes',            'slug' => 'kubernetes',            'version' => null, 'type_id' => 1, 'dictionary_category_id' => 34,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'RabbitMQ',              'slug' => 'rabbitmq',              'version' => null, 'type_id' => 1, 'dictionary_category_id' => 8,   'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'GraphQL',               'slug' => 'graphql',               'version' => null, 'type_id' => 1, 'dictionary_category_id' => 12,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Django',                'slug' => 'django',                'version' => null, 'type_id' => 1, 'dictionary_category_id' => 11,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'DynamoDB',              'slug' => 'dynamodb',              'version' => null, 'type_id' => 1, 'dictionary_category_id' => 8,   'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Datadog',               'slug' => 'datadog',               'version' => null, 'type_id' => 1, 'dictionary_category_id' => 8,   'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'C#',                    'slug' => 'csharp',                'version' => null, 'type_id' => 1, 'dictionary_category_id' => 12,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'Drupal',                'slug' => 'drupal',                'version' => null, 'type_id' => 1, 'dictionary_category_id' => 37,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'SOAP',                  'slug' => 'soap',                  'version' => null, 'type_id' => 1, 'dictionary_category_id' => 23,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'NextJS',                'slug' => 'nextjs',                'version' => null, 'type_id' => 1, 'dictionary_category_id' => 11,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
            [ 'name' => 'OAuth',                 'slug' => 'oauth',                 'version' => null, 'type_id' => 1, 'dictionary_category_id' => 23,  'featured' => 0, 'level' => 0,  'years' => 0,   'start_year' => null, 'end_year' => null, 'is_public' => 0 ],
        ...
        if (!empty($data)) {
            DB::connection(self::DB_TAG)->table('anti_skills')->insert(
                $this->additionalColumns($data, true, $this->adminId, ['is_demo' => $this->is_demo])
            );
        }
        $this->insertSystemAdminResource($this->adminId, 'anti_skills', [ 'is_public' => !empty($data) ]);
    }
    ...
    protected function insertPortfolioVideos(): void
    {
        ...
        $data = [
            [
                ...
                'featured'         => 1,
                'summary'          => '<b>Live Around Town</b> was a public access television show that aired in Chapel Hill, NC in the mid-1990\'s. Originally conceived and produced by myself, I was quickly joined by Rob Linder who helped a lot with both the filming and production. It featured mostly local bands and musicians performing at venues from around the Research Triangle area of North Carolina.',
                'full_episode'     => 1,
                'clip'             => 0,
                'public_access'    => 1,
                'source_recording' => 0,
            ...
            [
                ...
                'featured'         => 1,
                'summary'          => '<b>Bandelirium</b> as a music-oriented game show created by Mr. Mouse and myself that was recorded at the Cave in Chapel, NC and aired on Chapel Hill, NC public access television in the late 1990s.',
                'full_episode'     => 1,
                'clip'             => 0,
                'public_access'    => 1,
                'source_recording' => 0,
            ...
            [
                ...
                'featured'         => 1,
                'summary'          => 'This is a documentary of the inaugural <i>Sleazefest!</i>, an annual weekend of "bands, B-movies, and barbecue" that took place at Local 506 in Chapel Hill, NC every August from 1994 until the early 2000s. I organized the video production for the event and, along with Rob Linder and Matt Johnson, created this full-length video. An audio CD and full-length double album was also produced of the event.',
                'full_episode'     => 1,
                'clip'             => 0,
                'public_access'    => 0,
                'source_recording' => 0,
            ...
            [
                ...
                'featured'         => 1,
                'summary'          => 'This was a video I produced of the song "Ramadan Romance" by the Athens, GA band <b>The Woggles</b>. It was filmed at the Star Bar in Atlanta by myself and Chapel Hill videographer Davis Stillson and edited by myself using only pro-sumer Hi-8 and S-VHS equipment.',
                'full_episode'     => 0,
                'clip'             => 0,
                'public_access'    => 0,
                'source_recording' => 0,
            ...
            [
                ...
                'featured'         => 0,
                'summary'          => '<b>Live @ the Cave</b> was a public access television show that was recorded at the Cave in Chapel Hill, NC in the late 1990s. It featured live performances from local bands and musicians. The show was created by Cave owner, Mr. Mouse, and myself and recorded by dedicated teams of amateur music enthusiasts.',
                'full_episode'     => 0,
                'clip'             => 0,
                'public_access'    => 1,
                'source_recording' => 0,
            ...
            [
                ...
                'featured'         => 1,
                'summary'          => '<b>The Somnambulist Project</b> was a theater troupe that formed in Michigan and relocated to Chapel Hill, NC in the mid-1990\s. They performed all original productions throughout the late 1990s. I don\'t recall how I hooked up with them but I became a huge fan and their unofficial videographer, orchestrating multi-camera video shoots of most ot their productions.',
                'full_episode'     => 1,
                'clip'             => 0,
                'public_access'    => 0,
                'source_recording' => 0,

...
namespace App\Console\Commands\SampleAdmins\AlexReiger;
...
class InitPortfolio extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:init-alex-reiger-portfolio {--silent}';
     ...
     * @var string
     */
    protected $description = 'This will populate the portfolio database with initial data for admin alex-reiger.';

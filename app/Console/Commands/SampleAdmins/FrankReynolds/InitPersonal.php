...
class InitPersonal extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:init-frank-reynolds-personal {--silent}';
     ...
     * @var string
     */
    protected $description = 'This will populate the personal database with initial data for admin frank-reynolds.';

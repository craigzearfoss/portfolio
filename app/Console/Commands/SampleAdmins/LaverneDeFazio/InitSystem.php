...
namespace App\Console\Commands\SampleAdmins\LaverneDeFazio;
...
class InitSystem extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:init-laverne-de-fazio-system {--silent}';
     ...
     * @var string
     */
    protected $description = 'This will populate the system database with initial data for admin laverne-de-fazio.';

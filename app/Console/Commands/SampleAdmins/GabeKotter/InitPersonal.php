...
class InitPersonal extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:init-gabe-kotter-personal {--silent}';
     ...
     * @var string
     */
    protected $description = 'This will populate the personal database with initial data for admin gabe-kotter.';

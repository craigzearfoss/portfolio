...
class InitCareer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:init-gabe-kotter-career {--silent}';
     ...
     * @var string
     */
    protected $description = 'This will populate the career database with initial data for admin gabe-kotter.';

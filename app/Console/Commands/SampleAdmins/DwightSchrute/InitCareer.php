...
namespace App\Console\Commands\SampleAdmins\DwightSchrute;
...
class InitCareer extends Command
{
     ...
     * @var string
     */
    protected $description = 'This will populate the career database with initial data for admin dwight-schrute.';

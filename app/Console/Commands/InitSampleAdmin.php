...
class InitSampleAdmin extends Command
{
    ...
    const array USER_DATA = [
        'demo'             => [ 'name' => 'Demo Admin',       'employment_status_id' => 1, 'label' => 'demo-admin',       'email' => 'admin@gmail.com',                   'role' => 'Site Administrator',       'employer' => null                            ],
        'alex-reiger'      => [ 'name' => 'Alex Reiger',      'employment_status_id' => 4, 'label' => 'alex-reiger',      'email' => 'areiger29@taxinyc.com',             'role' => 'Taxi Driver',              'employer' => 'Sunshine Cab Company'          ],
        'dwight-schrute'   => [ 'name' => 'Dwight Schrute',   'employment_status_id' => 1, 'label' => 'dwight-schrute',   'email' => 'dwight@dunder-mifflin.com',         'role' => 'Salesman',                 'employer' => 'Dunder-Mifflin Paper Company'  ],
        'frank-reynolds'   => [ 'name' => 'Frank Reynolds',   'employment_status_id' => 2, 'label' => 'frank-reynolds',   'email' => 'frank@paddys-pub.com',              'role' => 'Co-owner of Paddy\'s Pub', 'employer' => 'Paddy\'s Pub'                  ],
        'fred-flintstone'  => [ 'name' => 'Fred Flintstone',  'employment_status_id' => 1, 'label' => 'fred-flintstone',  'email' => 'fatfred@bedrock.com',               'role' => 'Crane Operator',           'employer' => 'Slate Rock and Gravel Company' ],
        'gabe-kotter'      => [ 'name' => 'Gabe Kotter',      'employment_status_id' => 3, 'label' => 'gabe-kotter',      'email' => 'mrkotter@james-buchanan.edu',       'role' => 'English Teacher',          'employer' => 'James Buchanan High School'    ],
        'jed-clampett'     => [ 'name' => 'Jed Clampett',     'employment_status_id' => 1, 'label' => 'jed-clampett',     'email' => 'jed@clampett-oil.com',              'role' => 'Family Patriarch',         'employer' => 'O.K. Oil Company'              ],
        'j-r-ewing'        => [ 'name' => 'J.R. Ewing',       'employment_status_id' => 1, 'label' => 'j-r-ewing',        'email' => 'jr@ewing-oil.com',                  'role' => 'President of Ewing Oil',   'employer' => 'Ewing Oil'                     ],
        'laverne-de-fazio' => [ 'name' => 'Laverne De Fazio', 'employment_status_id' => 1, 'label' => 'laverne-de-fazio', 'email' => 'ldefazio@shotz.com',                'role' => 'Bottle Capper',            'employer' => 'Shotz Brewery'                 ],
        'peter-gibbons'    => [ 'name' => 'Peter Gibbons',    'employment_status_id' => 4, 'label' => 'peter-gibbons',    'email' => 'peter.gibbons@initech.com',         'role' => 'Software Engineer',        'employer' => 'Initech'                       ],
        'sam-malone'       => [ 'name' => 'Sam Malone',       'employment_status_id' => 1, 'label' => 'sam-malone',       'email' => 'vic-ferrari@cheers.com',            'role' => 'Bartender',                'employer' => 'Cheers, Boston, MA'            ],
        'jonas-grumby'     => [ 'name' => 'Jonas Grumby',     'employment_status_id' => 1, 'label' => 'jonas-grumby',     'email' => 'skipper@ssminnow.com',              'role' => 'Boat Captain',             'employer' => 'SS Minnow Island Charter'      ],
        'herman-munster'   => [ 'name' => 'Herman Munster',   'employment_status_id' => 4, 'label' => 'herman-munster',   'email' => 'herman@gggfh.com',                  'role' => 'Boxer',                    'employer' => 'Gateman, Goodbury and Graves Funeral Home' ],
        'darrin-stephens'  => [ 'name' => 'Darrin Stephens',  'employment_status_id' => 1, 'label' => 'darrin-stephens',  'email' => 'dstephens@mcmannandtate.com',       'role' => 'Ad Executive',             'employer' => 'McMann & Tate'                 ],
        'ricky-ricardo'    => [ 'name' => 'Ricky Ricardo',    'employment_status_id' => 1, 'label' => 'ricky-ricardo',    'email' => 'ricky@desilu.com',                  'role' => 'Bandleader',               'employer' => 'Tropicana'                     ],
        'mike-brady'       => [ 'name' => 'Mike Brady',       'employment_status_id' => 4, 'label' => 'mike-brady',       'email' => 'mbrady@architects-r-us.net',        'role' => 'Architect',                'employer' => 'Generic Architecture Firm'      ],
        'dwayne-schneider' => [ 'name' => 'Dwayne Schneider', 'employment_status_id' => 4, 'label' => 'dwayne-schneider', 'email' => 'schneider@handyman.com',            'role' => 'Building Superintendent',  'employer' => 'self-employed'                 ],
        'hikaru-sulu'      => [ 'name' => 'Hikaru Sulu',      'employment_status_id' => 1, 'label' => 'hikaru-sulu',      'email' => 'sulu@starfleet.gov',                'role' => 'Helmsman',                 'employer' => 'USS Enterprise'                ],
        'les-nessman'      => [ 'name' => 'Les Nessman',      'employment_status_id' => 1, 'label' => 'les-nessman',      'email' => 'nessman@wkrp.com',                  'role' => 'News Director',            'employer' => 'WKRP Radio'                    ],
        'bo-darville'      => [ 'name' => 'Bo Darville',      'employment_status_id' => 6, 'label' => 'bo-darville',      'email' => 'bandit@daredevil.com',              'role' => 'Daredevil Driver',         'employer' => 'Big and Little Enos Burdett'   ],
        'dan-fielding'     => [ 'name' => 'Dan Fielding',     'employment_status_id' => 1, 'label' => 'dan-fielding',     'email' => 'dan.fielding@manhattan-court.gov',  'role' => 'Assistant District Attorney', 'employer' => 'Manhattan Criminal Court'   ],
    ];
        ...
        if (!empty($undefinedUsernames)) {
            if (count($undefinedUsernames) == 1) {
                $this->error('Username "' . $undefinedUsernames[0] . '" not defined.'
                    . PHP_EOL . 'Please specify a valid demo username or "all" to include all demo admins.');
            } else {

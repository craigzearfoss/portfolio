...
class InitPortfolio extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:init-lavernedefazio-portfolio {--silent}';
     ...
     * @var string
     */
    protected $description = 'This will populate the portfolio database with initial data for user lavernedefazio';

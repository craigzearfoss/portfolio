...
class InitPortfolio extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:init-dwightschrute-portfolio {--silent}';
     ...
     * @var string
     */
    protected $description = 'This will populate the portfolio database with initial data for user dwightschrute';

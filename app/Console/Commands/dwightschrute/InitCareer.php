...
class InitCareer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:init-dwightschrute-career {--silent}';
     ...
     * @var string
     */
    protected $description = 'This will populate the personal database with initial data for user dwightschrute';
    ...
    {
        // get the admin
        if (!$admin = Admin::where('username', 'dwightschrute')->first()) {
            echo PHP_EOL . 'Admin `dwightschrute` not found.' . PHP_EOL . PHP_EOL;
            die;
        }
        ...
        if (!$this->teamId = $admin->admin_team_id) {
            echo PHP_EOL . 'Admin `dwightschrute` is not on any admin teams.' . PHP_EOL;
        ...
        if (!$this->groupId = AdminAdminGroup::where('admin_id', $this->adminId)->first()->admin_group_id ?? null) {
            echo PHP_EOL . 'Admin `dwightschrute` does not belong to any admin groups.' . PHP_EOL;
            echo 'Please fix before running this script.' . PHP_EOL . PHP_EOL;
            die;
        }
    ...
    protected function insertCareerReferences(): void
    {
        ...
        $data = [
            ...
            [ 'name' => 'Kelly Kapoor',    'slug' => 'kelly-kapoor',    'friend' => 0, 'family' => 0, 'coworker' => 1, 'supervisor' => 0, 'subordinate' => 0, 'professional' => 0, 'other' => 0, 'company_id' => null, 'street' => null, 'street2' => null,  'city' => 'Bedrock', 'state_id' => null, 'zip' => null, 'country_id' => null, 'phone' => '(717) 555-1215', 'phone_label' => 'home',   'alt_phone' => '(717) 555-1207', 'alt_phone_label' => 'mobile', 'email' => 'kelly.kapoor@dunder-mifflin.com',    'email_label' => 'work', 'alt_email' => null, 'alt_email_label' => null, 'birthday' => null, 'link' => null, 'demo' => 1 ],
            [ 'name' => 'Meridith Palmer', 'slug' => 'meridith-palmer', 'friend' => 0, 'family' => 0, 'coworker' => 1, 'supervisor' => 0, 'subordinate' => 0, 'professional' => 0, 'other' => 0, 'company_id' => null, 'street' => null, 'street2' => null,  'city' => 'Bedrock', 'state_id' => null, 'zip' => null, 'country_id' => null, 'phone' => '(717) 555-1215', 'phone_label' => 'home',   'alt_phone' => '(717) 555-1207', 'alt_phone_label' => 'mobile', 'email' => 'meridith.palmer@dunder-mifflin.com', 'email_label' => 'work', 'alt_email' => null, 'alt_email_label' => null, 'birthday' => null, 'link' => null, 'demo' => 1 ],
            [ 'name' => 'Creed Bratton',   'slug' => 'creed-bratton',   'friend' => 0, 'family' => 0, 'coworker' => 1, 'supervisor' => 0, 'subordinate' => 0, 'professional' => 0, 'other' => 0, 'company_id' => null, 'street' => null, 'street2' => null,  'city' => 'Bedrock', 'state_id' => null, 'zip' => null, 'country_id' => null, 'phone' => '(717) 555-1215', 'phone_label' => 'home',   'alt_phone' => '(717) 555-1207', 'alt_phone_label' => 'mobile', 'email' => 'creed.bratton@dunder-mifflin.com',   'email_label' => 'work', 'alt_email' => null, 'alt_email_label' => null, 'birthday' => null, 'link' => null, 'demo' => 1 ],
            [ 'name' => 'Darryl Philbin',  'slug' => 'darryl-philbin',  'friend' => 0, 'family' => 0, 'coworker' => 1, 'supervisor' => 0, 'subordinate' => 0, 'professional' => 0, 'other' => 0, 'company_id' => null, 'street' => null, 'street2' => null,  'city' => 'Bedrock', 'state_id' => null, 'zip' => null, 'country_id' => null, 'phone' => '(717) 555-1215', 'phone_label' => 'home',   'alt_phone' => '(717) 555-1207', 'alt_phone_label' => 'mobile', 'email' => 'daryl.philbin@dunder-mifflin.com',   'email_label' => 'work', 'alt_email' => null, 'alt_email_label' => null, 'birthday' => null, 'link' => null, 'demo' => 1 ],
        ];

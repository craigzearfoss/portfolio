...
class InitTonyNelson extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:init-tony-nelson {--silent}';
     ...
     * @var string
     */
    protected $description = 'This will populate the databases with initial data for admin tony-nelson';
    ...
    public function handle()
    {
        $commandSubdirectory = base_path() . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR . 'Console'
            ...
            . 'DemoAdmins' . DIRECTORY_SEPARATOR . 'TonyNelson' . DIRECTORY_SEPARATOR;
        ...
        if (file_exists($commandSubdirectory . 'initSystem.php')) {
            echo PHP_EOL .'Importing System data for tony-nelson ...' . PHP_EOL;
            Artisan::call('app:init-tony-nelson-system --silent');
        }

        if (file_exists($commandSubdirectory . 'initPortfolio.php')) {
            echo PHP_EOL . 'Importing Portfolio data for tony-nelson ...' . PHP_EOL;
            Artisan::call('app:init-tony-nelson-portfolio --silent');
        }

        if (file_exists($commandSubdirectory . 'initCareer.php')) {
            echo PHP_EOL . 'Importing Career data for tony-nelson  ...' . PHP_EOL;
            Artisan::call('app:init-tony-nelson-career --silent');
        }

        if (file_exists($commandSubdirectory . 'initPersonal.php')) {
            echo PHP_EOL . 'Importing Personal data for tony-nelson  ...' . PHP_EOL;
            Artisan::call('app:init-tony-nelson-personal --silent');
        }
    }
}

...
class InitSystem extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:init-fred-flintstone-system {--silent}';
     ...
     * @var string
     */
    protected $description = 'This will populate the system database with initial data for admin fred-flintstone.';

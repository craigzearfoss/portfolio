...
class JonasGrumby extends Command
{
    ...
    protected function insertPersonalReadings(): void
    {
        ...
        $data = [
            ...
            [ 'title' => 'Moby Dick',                             'author' => 'Herman Melville',     'slug' => 'moby-dick-by-herman-melville',                                  'publication_year' => 1851, 'fiction' => 1, 'nonfiction' => 0, 'paper' => 1, 'audio' => 0, 'wishlist' => 0, 'link' => 'https://en.wikipedia.org/wiki/Moby-Dick', 'link_name' => 'Wikipedia', 'image' => 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Moby-Dick_FE_title_page.jpg/250px-Moby-Dick_FE_title_page.jpg', 'public' => 1 ],

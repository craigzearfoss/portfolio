...
class DwightSchrute extends Command
{
    ...
    protected function insertPersonalReadings(): void
    {
        ...
        $data = [
            ...
            [ 'title' => 'The Stand',                             'author' => 'Stephen King',        'slug' => 'the-stand-by-stephen-king',                                     'publication_year' => 1978, 'fiction' => 1, 'nonfiction' => 0, 'paper' => 1, 'audio' => 0, 'wishlist' => 0, 'link' => 'https://en.wikipedia.org/wiki/The_Stand', 'link_name' => 'Wikipedia', 'image' => 'https://en.wikipedia.org/wiki/File:The_Stand_(1978)_front_cover,_first_edition.png', 'public' => 1 ],

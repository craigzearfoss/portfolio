...
class Demo extends Command
{
    ...
    protected function insertPortfolioMusic(): void
    {
        ...
        $data = [
            ...
            [ 'name' => 'Styrofoam',                                         'artist' => 'Tyla Gang',                     'slug' => 'styrofoam-by-tyla-gang',                                         'featured' => 0, 'summary' => null, 'collection' => 0, 'track' => 1, 'label' => null,                'catalog_number' => null,       'music_year' => 1977, 'release_date' => null,         'embed' => '<iframe width="560" height="315" src="https://www.youtube.com/embed/kWtbnDy378Q?si=4V8JaXzg36tz9v2S" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>', 'audio_url' => null, 'link' => 'https://youtu.be/kWtbnDy378Q?si=4V8JaXzg36tz9v2S', 'link_name' => 'YouTube', 'description' => null, 'is_public' => 1 ],

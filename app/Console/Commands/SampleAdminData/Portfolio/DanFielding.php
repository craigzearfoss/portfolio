...
class DanFielding extends Command
{
    ...
    protected function insertPortfolioArt(): void
    {
        ...
        $data = [
            [ 'name' => 'untitled',                   'artist' => 'Kevin Dixon',       'slug' => 'untitled-by-kevin-dixon',                   'summary' => null, 'year' => null, 'featured' => 0, 'public' => 1, 'image' => null,                                                                                                                                                           'link_name' => null,              'link' => 'https://www.facebook.com/kdixon', 'notes' => null, 'description' => null ],
            [ 'name' => '(untitled)',                 'artist' => 'Wes Freed',         'slug' => '(untitled-4)-by-wes-freed',                 'summary' => null, 'year' => null, 'featured' => 0, 'public' => 1, 'image' => 'https://img.broadtime.com/418467274739:500.png',                                                                                                               'link_name' => null,              'link' => null,                              'notes' => null, 'description' => null ],
            [ 'name' => '(untitled)',                 'artist' => 'Wes Freed',         'slug' => '(untitled-2)-by-wes-freed',                 'summary' => null, 'year' => null, 'featured' => 0, 'public' => 1, 'image' => 'https://bloximages.newyork1.vip.townnews.com/roanoke.com/content/tncms/assets/v3/editorial/1/57/157797a6-b406-551a-a0d8-824a63bedb88/5d473512aa116.image.jpg', 'link_name' => null,              'link' => null,                              'notes' => null, 'description' => null ],
            ...
            [ 'name' => 'Check Book Blues',           'artist' => 'Ron Liberti',       'slug' => 'check-book-blues-by-ron-liberti',           'summary' => null, 'year' => 2010, 'featured' => 0, 'public' => 1, 'image' => 'https://images.squarespace-cdn.com/content/v1/57263ec81d07c02f9c27edc7/1463251795854-2KQSYXO1K69YY7145JVH/bigcheckbook.jpg?format=750w',                       'link_name' => 'Ron Liberti Art', 'link' => 'https://www.ronlibertiart.com/',  'notes' => null, 'description' => null ],
            [ 'name' => 'Home Is Where the Chair Is', 'artist' => 'Ron Liberti',       'slug' => 'home-is-where-the-chair-is-by-ron-liberti', 'summary' => null, 'year' => null, 'featured' => 0, 'public' => 1, 'image' => 'https://images.squarespace-cdn.com/content/v1/57263ec81d07c02f9c27edc7/1464470818168-5NEY2A6XXM4MJYG0AH1A/homechair.jpg?format=750w',                          'link_name' => 'Ron Liberti Art', 'link' => 'https://www.ronlibertiart.com/',  'notes' => null, 'description' => null ],
            /*
            [
                'name'        => '',
                'artist'      => null,
    ...
    protected function insertPortfolioJobCoworkers(): void
    {
        ...
        $data = [
            [ 'job_id' => $this->jobId[1], 'name' => 'Harold T. Stone',     'title' => 'Judge',           'level_id' => 1, 'work_phone' => null,             'personal_phone' => null,             'work_email' => null,                      'personal_email' => null,                   'link' => null, 'link_name' => null ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Nostradamus Shannon', 'title' => 'Bailiff',         'level_id' => 2, 'work_phone' => null,             'personal_phone' => null,             'work_email' => null,                      'personal_email' => null,                   'link' => null, 'link_name' => null ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Christine Sullivan',  'title' => 'Public Defender', 'level_id' => 1, 'work_phone' => null,             'personal_phone' => null,             'work_email' => null,                      'personal_email' => null,                   'link' => null, 'link_name' => null ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Rosalind Russell',    'title' => 'Bailiff',         'level_id' => 1, 'work_phone' => null,             'personal_phone' => null,             'work_email' => null,                      'personal_email' => null,                   'link' => null, 'link_name' => null ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Macintosh Robinson',  'title' => 'Court Clerk',     'level_id' => 1, 'work_phone' => null,             'personal_phone' => null,             'work_email' => null,                      'personal_email' => null,                   'link' => null, 'link_name' => null ],
        ];

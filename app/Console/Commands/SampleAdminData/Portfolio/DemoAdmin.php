...
class DemoAdmin extends Command
{
    ...
    protected function insertPortfolioJobCoworkers(): void
    {
        ...
        $data = [
            [ 'job_id' => $this->jobId[1], 'name' => 'Walter White',     'job_title' => 'Chemistry Teacher',                             'level_id' => 2, 'work_phone' => '(208) 555-0507', 'personal_phone' => '(208) 555-3644',  'work_email' => 'walter.white@chemistry.eduv',       'personal_email' => null,                         'link' => null, 'link_name' => null ],

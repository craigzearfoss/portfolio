...
class HermanMunster extends Command
{
    ...
    protected function insertPortfolioArt(): void
    {
        ...
        $data = [
            [ 'name' => 'Water Lily Pond, (Symphony in Green)', 'artist' => 'Claude Monet',                  'slug' => 'water-lily-pond-(symphony-in-green)-by-claude-monet',   'summary' => null, 'year' => 1899, 'featured' => 0, 'is_public' => 1, 'image' => 'https://cdn.topofart.com/images/artists/Claude_Oscar_Monet/paintings-wm/monet018.jpg',             'link_name' => 'Top of Art', 'link' => 'https://www.topofart.com/',       'notes' => null, 'description' => null ],
            [ 'name' => 'The Grande Odalisque',                 'artist' => 'Jean Auguste Dominique Ingres', 'slug' => 'the-grande-odalisque-by-jean-auguste-dominique-ingres', 'summary' => null, 'year' => 1814, 'featured' => 0, 'is_public' => 1, 'image' => 'https://cdn.topofart.com/images/artists/Jean_Auguste_Dominique_Ingres/paintings-wm/ingres026.jpg', 'link_name' => 'Top of Art', 'link' => 'https://www.topofart.com/',       'notes' => null, 'description' => null ],
            [ 'name' => 'Birthday Card',      'artist' => 'Kevin Dixon',                   'slug' => 'birthday-card-by-by-kevin-dixon',                          'summary' => null, 'year' => null, 'featured' => 0, 'is_public' => 1, 'image' => null,                                                                                               'link_name' => null,         'link' => 'https://www.facebook.com/kdixon', 'notes' => null, 'description' => null ],
            /*
            [
                'name'        => '',
                'artist'      => null,
    ...
    protected function insertPortfolioCourses(): void
    {
        ...
        $data = [
            ...
            [ 'name' => 'Modern React with Redux',                                      'slug' => 'modern-react-with-redux',                                      'completed' => 1, 'completion_date' => '2023-04-04', 'year' => 2023, 'duration_hours' => 75.5, 'academy_id' => 8, 'instructor' => 'Stephen Grider',         'sponsor' => null, 'certificate_url' => null, 'link' => 'https://www.udemy.com/course/react-redux/',                                         'link_name' => null, 'is_public' => 1, 'summary' => 'Master React and Redux. Apply modern design patterns to build apps with React Router, TailwindCSS, Context, and Hooks!' ],
    ...
    protected function insertPortfolioJobSkills(): void
    {
        ...
        if (!empty($data)) {
            ...
            $this->insertSystemAdminResource($this->adminId, 'job_skils');
        }
    }
    ...
    protected function insertPortfolioSkills(): void
    {
        ...
        $data = [
            [ 'name' => 'carpentry', 'slug' => 'carpentry', 'version' => null, 'featured' => 1, 'type_id' => 1, 'dictionary_category_id' => null, 'level' => null, 'years' => null, 'start_year' => null, 'is_public' => 1 ],
            [ 'name' => 'humor',     'slug' => 'humor',     'version' => null, 'featured' => 0, 'type_id' => 0, 'dictionary_category_id' => null, 'level' => null, 'years' => null, 'start_year' => null, 'is_public' => 1 ],
            /*
            [
                'name'                   => '',
                'slug'                   => '',

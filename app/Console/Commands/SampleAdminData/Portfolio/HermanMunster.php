...
class HermanMunster extends Command
{
    ...
    protected function insertPortfolioArt(): void
    {
        ...
        $data = [
            ...
            [ 'name' => 'Birthday Card',      'artist' => 'Kevin Dixon',                   'slug' => 'birthday-card-by-kevin-dixon',                          'summary' => null, 'year' => null, 'featured' => 0, 'is_public' => 1, 'image' => null,                                                                                               'link_name' => null,         'link' => 'https://www.facebook.com/kdixon', 'notes' => null, 'description' => null ],
            /*
            [
                'name'        => '',
                'artist'      => null,

...
class DarrinStephens extends Command
{
    ...
    protected function insertPortfolioArt(): void
    {
        ...
        $data = [
            ...
            [ 'name' => 'There Is a God',                   'artist' => 'Kevin Dixon',            'slug' => 'there-is-a-god-by-by-kevin-dixon',                           'summary' => null, 'art_year' => null, 'featured' => 0, 'is_public' => 1, 'image' => null,                                                                                           'link_name' => null,         'link' => 'https://www.facebook.com/kdixon', 'notes' => null, 'description' => null ],
            /*
            [
                'name'        => '',
                'artist'      => null,
    ...
    protected function insertPortfolioCourses(): void
    {
        ...
        $data = [
            ...
            [ 'name' => 'Vue.js 3 Masterclass: Build 7 Real-World Apps',      'slug' => 'vue.js-3-masterclass-build-7-real-world-apps',        'completed' => 1, 'completion_date' => '2017-09-09', 'course_year' => 2017, 'duration_hours' => 15.5, 'academy_id' => 8, 'instructor' => 'Piotr Jura',                           'sponsor' => null, 'certificate_url' => null, 'link' => 'https://www.udemy.com/course/vue-in-action/',                 'link_name' => null, 'is_public' => 1, 'summary' => 'Master Vue 3 & the Composition API by building 7 production-ready apps and launching your frontend developer career!' ],
    ...
    protected function insertPortfolioEducations(): void
    {
        ...
        $data = [
            [
                ...
                'enrollment_date'    => '1965-08-01',
                'graduated'          => 1,
                'graduation_date'    => '1969-06-01',
    ...
    protected function insertPortfolioMusic(): void
    {
        ...
        $data = [
            ...
            [ 'name' => 'Green Lights',              'artist' => 'NRBQ',                               'slug' => 'green-lights-by-nrbq',                              'featured' => 0, 'summary' => null, 'collection' => 0, 'track' => 1, 'label' => 'Mercury Records',   'catalog_number' => null,       'music_year' => 1978, 'release_date' => null,         'embed' => '<iframe width="560" height="315" src="https://www.youtube.com/embed/L2xdXNSBZrM?si=V2-b4RJK7LekUAOh" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>', 'audio_url' => null, 'link' => 'https://youtu.be/L2xdXNSBZrM?si=V2-b4RJK7LekUAOh', 'link_name' => 'YouTube', 'description' => null, 'is_public' => 1 ],
    ...
    protected function insertPortfolioSkills(): void
    {
        ...
        $data = [
            [ 'name' => 'sales',              'slug' => 'sales',              'version' => null, 'featured' => 0, 'type_id' => 0, 'dictionary_category_id' => null, 'level' => 8, 'years' => 6, 'start_year' => null, 'is_public' => 1 ],
            [ 'name' => 'customer relations', 'slug' => 'customer-relations', 'version' => null, 'featured' => 0, 'type_id' => 0, 'dictionary_category_id' => null, 'level' => 7, 'years' => 4, 'start_year' => null, 'is_public' => 1 ],
            [ 'name' => 'advertising',        'slug' => 'advertising',        'version' => null, 'featured' => 1, 'type_id' => 0, 'dictionary_category_id' => null, 'level' => 9, 'years' => 8, 'start_year' => null, 'is_public' => 1 ],
            /*
            [
                'name'                   => '',
                'slug'                   => '',

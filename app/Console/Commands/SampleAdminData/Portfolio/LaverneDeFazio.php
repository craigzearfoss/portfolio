...
class LaverneDeFazio extends Command
{
    ...
    protected function insertPortfolioArt(): void
    {
        ...
        $data = [
            ...
            [ 'name' => 'Different Stripes For Different Types', 'artist' => 'Kevin Dixon',                       'slug' => 'different-stripes-for-different-types-by-kevin-dixon',      'summary' => null, 'year' => null, 'featured' => 0, 'is_public' => 1, 'image' => null,                                                                                                       'link_name' => null,         'link' => 'https://www.facebook.com/kdixon', 'notes' => null, 'description' => null ],

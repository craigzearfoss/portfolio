...
class PeterGibbons extends Command
{
    ...
    protected function insertPortfolioArt(): void
    {
        ...
        $data = [
            ...
            [ 'name' => 'Manifest Destiny',        'artist' => 'Kevin Dixon',      'slug' => 'manifest-destiny-by-kevin-dixon',                                  'summary' => null, 'year' => null, 'featured' => 0, 'is_public' => 1, 'image' => null,                                                                                                                              'link_name' => null,         'link' => 'https://www.facebook.com/kdixon', 'notes' => null, 'description' => null ],
    ...
    protected function insertPortfolioJobCoworkers(): void
    {
        ...
        $data = [
            [ 'job_id' => $this->jobId[1], 'name' => 'Bill Lumbergh,',      'title' => 'Vice President',  'level_id' => 2, 'phone' => '(208) 555-9461', 'phone_label' => 'personal', 'alt_phone' => null,             'alt_phone_label' => null,       'email' => 'barney.rubble@slate.com', 'email_label' => 'work', 'alt_email' => null, 'alt_email_label' => null, 'link' => null, 'link_name' => null ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Milton Waddams',      'title' => 'Collator',        'level_id' => 1, 'phone' => '(208) 555-0507', 'phone_label' => 'work',     'alt_phone' => '(208) 555-2349', 'alt_phone_label' => 'personal', 'email' => 'slate@inl.slate.com',     'email_label' => 'work', 'alt_email' => null, 'alt_email_label' => null, 'link' => null, 'link_name' => null ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Michael Bolton',      'title' => 'Programmer',      'level_id' => 1, 'phone' => '(208) 555-3509', 'phone_label' => 'personal', 'alt_phone' => null,             'alt_phone_label' => null,       'email' => 'barney.rubble@slate.com', 'email_label' => 'work', 'alt_email' => null, 'alt_email_label' => null, 'link' => null, 'link_name' => null ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Samir Nagheenanajar', 'title' => 'Programmer',      'level_id' => 1, 'phone' => '(208) 555-0667', 'phone_label' => 'personal', 'alt_phone' => null,             'alt_phone_label' => null,       'email' => 'barney.rubble@slate.com', 'email_label' => 'work', 'alt_email' => null, 'alt_email_label' => null, 'link' => null, 'link_name' => null ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Tom Smykowski,',      'title' => 'Product Manager', 'level_id' => 1, 'phone' => '(208) 555-1191', 'phone_label' => 'personal', 'alt_phone' => null,             'alt_phone_label' => null,       'email' => 'barney.rubble@slate.com', 'email_label' => 'work', 'alt_email' => null, 'alt_email_label' => null, 'link' => null, 'link_name' => null ],
            /*
            [
                'job_id'         => $this->jobId[1],
                'name'           => '',
    ...
    protected function insertPortfolioSkills(): void
    {
        ...
        $data = [
            [ 'name' => 'software development', 'slug' => 'software-development', 'version' => null, 'featured' => 1, 'type_id' => 1, 'dictionary_category_id' => null, 'level' => null, 'years' => null, 'start_year' => null, 'is_public' => 1 ],
            [ 'name' => 'filling out forms',    'slug' => 'filling-out-forms',    'version' => null, 'featured' => 0, 'type_id' => 0, 'dictionary_category_id' => null, 'level' => null, 'years' => null, 'start_year' => null, 'is_public' => 1 ],
            [ 'name' => 'COBOL',                'slug' => 'cobol',                'version' => null, 'featured' => 0, 'type_id' => 1, 'dictionary_category_id' => null, 'level' => null, 'years' => null, 'start_year' => null, 'is_public' => 1 ],
            [ 'name' => 'karaoke',              'slug' => 'karaoke',              'version' => null, 'featured' => 0, 'type_id' => 0, 'dictionary_category_id' => null, 'level' => null, 'years' => null, 'start_year' => null, 'is_public' => 1 ],
            /*
            [
                'name'                   => '',
                'slug'                   => '',
        ...
        if (!empty($data)) {
            ...
            $this->insertSystemAdminResource($this->adminId, 'skill');
        }
    }
    ...
    protected function insertPortfolioVideos(): void
    {
        ...
        if (!empty($data)) {
            ...
            $this->insertSystemAdminResource($this->adminId, 'video');
        }
    }

...
class PeterGibbons extends Command
{
    ...
    protected function insertPortfolioArt(): void
    {
        ...
        $data = [
            [ 'name' => 'Hot Dog',                 'artist' => 'Kevin Dixon',      'slug' => 'hot-dog-by-kevin-dixon',                                           'summary' => null, 'year' => null, 'featured' => 0, 'public' => 1, 'image_url' => null,                                                                                                                              'link_name' => null,         'link' => 'https://www.facebook.com/kdixon', 'notes' => null, 'description' => null ],
            [ 'name' => 'Woman with a Parasol - Madame Monet and Her Son', 'artist' => 'Claude Monet',     'slug' => 'woman-with-a-parasol-madame-monet-and-her-son-by-claude-monet',    'summary' => null, 'year' => 1875, 'featured' => 0, 'public' => 1, 'image_url' => 'https://cdn.topofart.com/images/artists/Claude_Oscar_Monet/paintings-wm/monet177.jpg',                                            'link_name' => 'Top of Art', 'link' => 'https://www.topofart.com/',       'notes' => null, 'description' => null ],
            [ 'name' => 'Manifest Destiny',        'artist' => 'Kevin Dixon',      'slug' => 'manifest-destiny-by-kevin-dixon',                                  'summary' => null, 'year' => null, 'featured' => 0, 'public' => 1, 'image_url' => null,                                                                                                                              'link_name' => null,         'link' => 'https://www.facebook.com/kdixon', 'notes' => null, 'description' => null ],
            ...
            [ 'name' => 'Self Portrait',           'artist' => 'Vincent van Gogh', 'slug' => 'self-portrait-by-vincent-van-gogh',                                'summary' => null, 'year' => 1889, 'featured' => 0, 'public' => 1, 'image_url' => 'https://cdn.topofart.com/images/artists/Vincent_van_Gogh/paintings-wm/gogh058.jpg',                                               'link_name' => 'Top of Art', 'link' => 'https://www.topofart.com/',       'notes' => null, 'description' => null ],
            /*
            [
                'name'        => '',
                'artist'      => null,

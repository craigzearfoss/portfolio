...
class JREwing extends Command
{
    ...
    protected function insertPortfolioJobCoworkers(): void
    {
        ...
        $data = [
            [ 'job_id' => $this->jobId[1], 'name' => 'Eleanor Ewing Farlow', 'title' => 'Matriarch', 'level_id' => 1, 'link' => null, 'link_name' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[1], 'name' => 'John Ross Ewing Sr.',  'title' => 'Founder',   'level_id' => 2, 'link' => null, 'link_name' => null, 'is_public' => 1 ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Bobby Ewing.',         'title' => 'Executive', 'level_id' => 1, 'link' => null, 'link_name' => null, 'is_public' => 1 ],
            /*
            [
                'job_id'         => $this->jobId[1],
                'name'           => '',
    ...
    protected function insertPortfolioSkills(): void
    {
        ...
        $data = [
            [ 'name' => 'executive management', 'slug' => 'executive-management', 'version' => null, 'featured' => 1, 'type_id' => 0, 'dictionary_category_id' => null, 'level' => 9,  'years' => 7,  'start_year' => null, 'is_public' => 1 ],
            [ 'name' => 'Powerpoint',           'slug' => 'filling-out-forms',    'version' => null, 'featured' => 0, 'type_id' => 1, 'dictionary_category_id' => null, 'level' => 8,  'years' => 7,  'start_year' => null, 'is_public' => 1 ],
            [ 'name' => 'decision making',      'slug' => 'decision-making',      'version' => null, 'featured' => 0, 'type_id' => 0, 'dictionary_category_id' => null, 'level' => 8,  'years' => 6,  'start_year' => null, 'is_public' => 1 ],
            [ 'name' => 'leadership',           'slug' => 'leadership',           'version' => null, 'featured' => 1, 'type_id' => 0, 'dictionary_category_id' => null, 'level' => 10, 'years' => 12, 'start_year' => null, 'is_public' => 1 ],
            /*
            [
                'name'                   => '',
                'slug'                   => '',

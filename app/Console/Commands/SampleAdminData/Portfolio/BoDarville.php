...
class BoDarville extends Command
{
    ...
    protected function insertPortfolioEducations(): void
    {
        ...
        $data = [
            [
                ...
                'enrollment_date'    => '1978-01-01',
                'graduated'          => 1,
                'graduation_date'    => '1975-01-01',
    ...
    protected function insertPortfolioJobCoworkers(): void
    {
        ...
        $data = [
            [ 'job_id' => $this->jobId[1], 'name' => 'Cledus Snow',    'title' => 'Bootlegger',  'level_id' => 1, 'link' => null, 'link_name' => null ],
        ];
    ...
    protected function insertPortfolioSkills(): void
    {
        ...
        $data = [
            [ 'name' => 'racing',         'slug' => 'racing',         'version' => null, 'featured' => 0, 'type_id' => 0, 'dictionary_category_id' => null, 'level' => 10, 'years' => 4,  'start_year' => null, 'is_public' => 1 ],
            [ 'name' => 'street racing',  'slug' => 'street-racing',  'version' => null, 'featured' => 0, 'type_id' => 0, 'dictionary_category_id' => null, 'level' => 8,  'years' => 3,  'start_year' => null, 'is_public' => 1 ],
            [ 'name' => 'evading police', 'slug' => 'evading-police', 'version' => null, 'featured' => 0, 'type_id' => 0, 'dictionary_category_id' => null, 'level' => 7,  'years' => 10, 'start_year' => null, 'is_public' => 1 ],
            [ 'name' => 'wisecracks',     'slug' => 'wisecracks',     'version' => null, 'featured' => 0, 'type_id' => 0, 'dictionary_category_id' => null, 'level' => 8,  'years' => 20, 'start_year' => null, 'is_public' => 1 ],
            /*
            [
                'name'                   => '',
                'slug'                   => '',

...
class LesNessman extends Command
{
    ...
    protected function insertPortfolioArt(): void
    {
        ...
        $data = [
            [ 'name' => 'Post Glass Houses…Not!',                             'artist' => 'Ron Liberti',              'slug' => 'post-glass-houses-not-by-by-ron-liberti',                                          'summary' => null, 'year' => null, 'featured' => 0, 'is_public' => 1, 'image' => 'https://images.squarespace-cdn.com/content/v1/57263ec81d07c02f9c27edc7/1674831285050-4DZD1L3DN4CGGM1ZFO61/image-asset.jpeg?format=1500w',              'link_name' => 'Ron Liberti Art', 'link' => 'https://www.ronlibertiart.com/',  'notes' => null, 'description' => null ],
            [ 'name' => 'Boulevard des Capucines',                            'artist' => 'Claude Monet',             'slug' => 'boulevard-des-capucines-by-claude-monet',                                       'summary' => null, 'year' => 1873, 'featured' => 0, 'is_public' => 1, 'image' => 'https://cdn.topofart.com/images/artists/Claude_Oscar_Monet/paintings-wm/monet195.jpg',                                                                 'link_name' => 'Top of Art',      'link' => 'https://www.topofart.com/',       'notes' => null, 'description' => null ],
    ...
    protected function insertPortfolioAwards(): void
    {
        ...
        $data = [
            [ 'name' => 'Buckeye Newshawk Award', 'slug' => 'buckeye-newshawk-award', 'category' => null, 'nominated_work' => null, 'featured' => 0, 'year' => null, 'organization' => null, 'is_public' => 1 ],
            [ 'name' => 'Silver Sow Award',       'slug' => 'silver-sow-award',       'category' => null, 'nominated_work' => null, 'featured' => 0, 'year' => null, 'organization' => null, 'is_public' => 1 ],
            [ 'name' => 'Copper Cob Award',       'slug' => 'copper-cob-award',       'category' => null, 'nominated_work' => null, 'featured' => 0, 'year' => null, 'organization' => null, 'is_public' => 1 ],
            /*
            [
                'name'            => '',
                'slug'            => '',
    ...
    protected function insertPortfolioCourses(): void
    {
        ...
        $data = [
            ...
            [ 'name' => 'Figma UI UX Design Essentials',                             'slug' => 'figma-ui-ux-design-essentials',                             'completed' => 1, 'completion_date' => '2023-01-27', 'year' => 2023, 'duration_hours' => 9.5,  'academy_id' => 8, 'instructor' => 'Daniel Walter Scott',                       'sponsor' => null, 'certificate_url' => null, 'link' => 'https://www.udemy.com/course/figma-ux-ui-design-user-experience-tutorial-course/',  'link_name' => null, 'is_public' => 1, 'summary' => 'Use Figma to get a job in UI Design, User Interface, User Experience design, UX Design & Web Design' ],
            /*
            [
                'name'            => '',
                'slug'            => '',

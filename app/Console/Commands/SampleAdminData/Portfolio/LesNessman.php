...
class LesNessman extends Command
{
    ...
    protected function insertPortfolioArt(): void
    {
        ...
        $data = [
            [ 'name' => 'Post Glass Houses…Not!',                             'artist' => 'Ron Liberti',              'slug' => 'post-glass-houses-not-by-ron-liberti',                                          'summary' => null, 'year' => null, 'featured' => 0, 'public' => 1, 'image' => 'https://images.squarespace-cdn.com/content/v1/57263ec81d07c02f9c27edc7/1674831285050-4DZD1L3DN4CGGM1ZFO61/image-asset.jpeg?format=1500w',              'link_name' => 'Ron Liberti Art', 'link' => 'https://www.ronlibertiart.com/',  'notes' => null, 'description' => null ],
            ...
            [ 'name' => 'Jean de Dinteville, Georges de Selve (Ambassadors)', 'artist' => 'Hans Holbein the Younger', 'slug' => 'jean-de-dinteville-georges-de-selve-(ambassadors)-by-hans-holbein-the-younger', 'summary' => null, 'year' => 1533, 'featured' => 0, 'public' => 1, 'image' => 'https://cdn.topofart.com/images/artists/Hans_the_Younger_Holbein/paintings-wm/holbein026.jpg',                                                         'link_name' => 'Top of Art',      'link' => 'https://www.topofart.com/',       'notes' => null, 'description' => null ],
            [ 'name' => 'Breezing Up (A Fair Wind)',                          'artist' => 'Winslow Homer',            'slug' => 'breezing-up-(a-fair-wind)-by-winslow-homer',                                    'summary' => null, 'year' => 1873, 'featured' => 0, 'public' => 1, 'image' => 'https://cdn.topofart.com/images/artists/Winslow_Homer/paintings-wm/homer062.jpg',                                                                      'link_name' => 'Top of Art',      'link' => 'https://www.topofart.com/',       'notes' => null, 'description' => null ],
            ...
            [ 'name' => 'The Skiff (La Yole)',                                'artist' => 'Pierre-Auguste Renoir',    'slug' => 'the-skiff-(la-yole)-by-pierre-auguste-renoir',                                  'summary' => null, 'year' => 1875, 'featured' => 0, 'public' => 1, 'image' => 'https://cdn.topofart.com/images/artists/Pierre-Auguste_Renoir/paintings-wm/renoir190.jpg',                                                             'link_name' => 'Top of Art',      'link' => 'https://www.topofart.com/',       'notes' => null, 'description' => null ],
            [ 'name' => 'Edelweiss',                                          'artist' => 'Kevin Dixon',              'slug' => 'edelweiss-by-kevin-dixon',                                                      'summary' => null, 'year' => null, 'featured' => 0, 'public' => 1, 'image' => null,                                                                                                                                                   'link_name' => null,              'link' => 'https://www.facebook.com/kdixon', 'notes' => null, 'description' => null ],
            /*
            [
                'name'        => '',
                'artist'      => null,
    ...
    protected function insertPortfolioJobCoworkers(): void
    {
        ...
        $data = [
            [ 'job_id' => $this->jobId[1], 'name' => 'Andy Travis',      'title' => 'Program Director', 'level_id' => 2, 'work_phone' => null,             'personal_phone' => null,        'work_email' => null,                      'personal_email' => null,                   'link' => null, 'link_name' => null ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Arthur Carlson',   'title' => 'General Manager',  'level_id' => 2, 'work_phone' => null,             'personal_phone' => null,        'work_email' => null,                      'personal_email' => null,                   'link' => null, 'link_name' => null ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Dr. Johnny Fever', 'title' => 'Disc Jockey',      'level_id' => 1, 'work_phone' => null,             'personal_phone' => null,        'work_email' => null,                      'personal_email' => null,                   'link' => null, 'link_name' => null ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Jennifer Marlowe', 'title' => 'Receptionist',     'level_id' => 1, 'work_phone' => null,             'personal_phone' => null,        'work_email' => null,                      'personal_email' => null,                   'link' => null, 'link_name' => null ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Herb Tarlek',      'title' => 'Sales Manager',    'level_id' => 1, 'work_phone' => null,             'personal_phone' => null,        'work_email' => null,                      'personal_email' => null,                   'link' => null, 'link_name' => null ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Venus Flytrap',    'title' => 'Disc Jockey',      'level_id' => 1, 'work_phone' => null,             'personal_phone' => null,        'work_email' => null,                      'personal_email' => null,                   'link' => null, 'link_name' => null ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Bailey Quarters',  'title' => 'Billing and Station Traffic', 'level_id' => 1, 'work_phone' => null,  'personal_phone' => null,        'work_email' => null,                      'personal_email' => null,                   'link' => null, 'link_name' => null ],
        ];

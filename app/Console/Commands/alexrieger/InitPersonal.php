...
class InitPersonal extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:init-alexrieger-personal {--silent}';
     ...
     * @var string
     */
    protected $description = 'This will populate the personal database with initial data for user alexrieger';

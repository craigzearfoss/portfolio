...
class InitPortfolio extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:init-petergibbons-portfolio {--silent}';
    ...
    protected function insertPortfolioJobCoworkers(): void
    {
        ...
        $data = [
            [ 'job_id' => $this->jobId[1], 'name' => 'Bill Lumbergh,',      'job_title' => 'Vice President',  'level_id' => 2, 'work_phone' => null,             'personal_phone' => '(208) 555-3644', 'work_email' => 'barney.rubble@slate.com', 'personal_email' => 'barneybc@bedrock.com', 'link' => null, 'link_name' => null, 'demo' => 1 ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Milton Waddams',      'job_title' => 'Collator',        'level_id' => 1, 'work_phone' => '(208) 555-0507', 'personal_phone' => '(208) 555-5399', 'work_email' => 'slate@inl.slate.com',     'personal_email' => null,                   'link' => null, 'link_name' => null, 'demo' => 1 ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Michael Bolton',      'job_title' => 'Programmer',      'level_id' => 1, 'work_phone' => null,             'personal_phone' => '(208) 555-3644', 'work_email' => 'barney.rubble@slate.com', 'personal_email' => 'barneybc@bedrock.com', 'link' => null, 'link_name' => null, 'demo' => 1 ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Samir Nagheenanajar', 'job_title' => 'Programmer',      'level_id' => 1, 'work_phone' => null,             'personal_phone' => '(208) 555-3644', 'work_email' => 'barney.rubble@slate.com', 'personal_email' => 'barneybc@bedrock.com', 'link' => null, 'link_name' => null, 'demo' => 1 ],
            [ 'job_id' => $this->jobId[1], 'name' => 'Tom Smykowski,',      'job_title' => 'Product Manager', 'level_id' => 1, 'work_phone' => null,             'personal_phone' => '(208) 555-3644', 'work_email' => 'barney.rubble@slate.com', 'personal_email' => 'barneybc@bedrock.com', 'link' => null, 'link_name' => null, 'demo' => 1 ],
        ];

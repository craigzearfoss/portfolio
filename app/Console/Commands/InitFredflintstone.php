...
class InitFredflintstone extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:init-fredflintstone {--silent}';
    ...
    public function handle()
    {
        $commandSubdirectory = base_path() . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR . 'Console'
            . DIRECTORY_SEPARATOR . 'Commands' . DIRECTORY_SEPARATOR . 'fredflintstone' . DIRECTORY_SEPARATOR;

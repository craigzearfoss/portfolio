...
use App\Exports\Portfolio\AudiosExport;
...
class AudioController extends BaseAdminController
{
    public function __construct(PermissionService $permissionService)
    {
        ...
        view()->share('resourceType', 'portfolio.audio');
    }
    ...
    public function export(): BinaryFileResponse
    {
        ...
        $filename = request()->has('timestamp')
            ? 'audios_' . date("Y-m-d-His") . '.xlsx'
            : 'audios.xlsx';

        return Excel::download(new AudiosExport(), $filename);
    }
}

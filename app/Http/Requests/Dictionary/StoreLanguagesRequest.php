...
class StoreLanguagesRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        if (!canCreate('App\Models\Dictionary\Language', $this->loggedInAdmin)) {
            throw ValidationException::withMessages([
                'GLOBAL' => App::environment('production')
                    ? 'Unauthorized to create dictionary language.'
                    : 'Unauthorized to create dictionary language for admin ' . $this->loggedInAdmin['id'] . '.'
            ]);

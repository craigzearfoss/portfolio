...
class StoreOperatingSystemsRequest extends FormRequest
{
    ...
    {
        return [
            'full_name'    => ['required', 'string', 'max:255', 'unique:'.OperatingSystem::class],
            'name'         => ['required', 'string', 'max:255', 'unique:'.OperatingSystem::class],
            'slug'         => ['required', 'string', 'max:255', 'unique:'.OperatingSystem::class],

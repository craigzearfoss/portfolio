...
class ServerStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'full_name'    => ['string', 'required', 'max:255', 'unique:dictionary_db.servers,full_name'],
            'name'         => ['string', 'required', 'max:255', 'unique:dictionary_db.servers,name'],
            'slug'         => ['string', 'required', 'max:255', 'unique:dictionary_db.servers,slug'],

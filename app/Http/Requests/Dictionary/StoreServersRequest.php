...
class StoreServersRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        if (!canCreate('App\Models\Dictionary\Server', $this->loggedInAdmin)) {
            throw ValidationException::withMessages([
                'GLOBAL' => App::environment('production')
                    ? 'Unauthorized to create dictionary server.'
                    : 'Unauthorized to create dictionary server for admin ' . $this->loggedInAdmin['id'] . '.'
            ]);

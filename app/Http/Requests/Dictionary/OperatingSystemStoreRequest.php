...
class OperatingSystemStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'full_name'    => ['string', 'required', 'max:255', 'unique:dictionary_db.operating_systems,full_name'],
            'name'         => ['string', 'required', 'max:255', 'unique:dictionary_db.operating_systems,name'],
            'slug'         => ['string', 'required', 'max:255', 'unique:dictionary_db.operating_systems,slug'],

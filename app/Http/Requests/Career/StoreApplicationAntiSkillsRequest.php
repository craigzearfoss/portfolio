 ...
 *
 */
class StoreApplicationAntiSkillsRequest extends StoreAppBaseRequest
{
    /**
    ...
    protected array $props = [
        ...
        'table'        => 'application_anti_skills',
        'key'          => 'application_anti_skill',
        'name'         => 'application-anti=skill',
        'label'        => 'application anti-skill',
        'class'        => 'App\Models\Career\ApplicationAntiSkill',
        'has_owner'    => true,
        'has_user'     => false,
    ];
    ...
    public function rules(): array
    {
        return [
            ...
            'name'                   => [
                ...
                'string',
                'max:255',
                Rule::unique('career_db.application_anti_skills', 'name')->where(function ($query) {

 ...
 *
 */
class StoreAntiSkillsRequest extends StoreAppBaseRequest
{
    /**
    ...
    {
        return [
            'owner_id.required'    => 'Please select an owner for the anti-skill.',
            'owner_id.exists'      => 'The specified owner does not exist.',
            'category_id.required' => 'Please select an category for the anti-skill.',

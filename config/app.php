...
return [
    ...
    */
    ...
    'open_enrollment'       => boolval(env('APP_OPEN_ENROLLMENT', '0')),
    'owner'                 => env('APP_OWNER', ''),
    'demo'                  => env('APP_DEMO', '0'),
    'demo_admin_enabled'    => boolval(env('APP_DEMO_ADMIN_ENABLED', '0')),
    'demo_admin_username'   => env('APP_DEMO_ADMIN_USERNAME', ''),
    'demo_admin_password'   => env('APP_DEMO_ADMIN_PASSWORD', ''),
    'demo_user_enabled'     => boolval(env('APP_DEMO_USER_ENABLED', '0')),
    'demo_user_username'    => env('APP_DEMO_USER_USERNAME', ''),
    'demo_user_password'    => env('APP_DEMO_USER_PASSWORD', ''),
    'readonly'              => boolval(env('APP_READONLY', '0')),
    'contactable'           => boolval(env('APP_CONTACTABLE', '0')),

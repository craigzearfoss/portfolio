...
return [
    ...
    */
    ...
    'coming_soon_template'    => env('COMING_SOON_TEMPLATE'),
    ...
    'demo_user_can_edit'      => boolval(env('APP_DEMO_USER_CAN_EDIT', false)),
    ...
    'mailing_list'            => boolval(env('APP_MAILING_LIST', false)),
    ...
    'secure_urls'             => boolval(env('APP_SECURE_URLS', false)),

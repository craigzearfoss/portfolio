...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'dictionary_db' => [
            'driver' => 'mysql',
            'url' => env('DICTIONARY_DB_URL'),
            'host' => env('DICTIONARY_DB_HOST', '127.0.0.1'),
            'port' => env('DICTIONARY_DB_PORT', '3306'),
            ...
            'unix_socket' => env('DICTIONARY_DB_SOCKET', ''),
            'charset' => env('DICTIONARY_DB_CHARSET', 'utf8mb4'),
            'collation' => env('DICTIONARY_DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
        ...
        'portfolio_db' => [
            ...
            'database' => env('PORTFOLIO_DB_DATABASE', 'portfolio'),
            'username' => env('PORTFOLIO_DB_USERNAME', 'root'),
            'password' => env('PORTFOLIO_DB_PASSWORD', ''),
            'unix_socket' => env('PORTFOLIO_DB_SOCKET', ''),
            'charset' => env('PORTFOLIO_DB_CHARSET', 'utf8mb4'),
            'collation' => env('PORTFOLIO_DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,

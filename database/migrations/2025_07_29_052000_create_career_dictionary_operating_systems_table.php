...
return new class extends Migration
{
    ...
    {
        Schema::connection('career_db')->create('dictionary_operating_systems', function (Blueprint $table) {
            $table->id();
        ...
        App\Models\Career\DictionaryOperatingSystem::insert($data);
    }
    ...
    {
        Schema::connection('career_db')->dropIfExists('dictionary_operating_systems');
    }
};

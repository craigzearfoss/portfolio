...
return new class extends Migration
{
    ...
    {
        Schema::connection('career_db')->create('dictionary_categories', function (Blueprint $table) {
            $table->id();
     ...
     //       [ 'id' => 0,  'name' => '' ],
        ...
        App\Models\Career\DictionaryCategory::insert($data);
    }
    ...
    public function down(): void
    {
        ...
        */
        ...
        Schema::connection('career_db')->dropIfExists('dictionary_categories');
    }
};

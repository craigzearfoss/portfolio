...
return new class extends Migration
{
    ...
    {
        Schema::connection('career_db')->create('dictionary_servers', function (Blueprint $table) {
            $table->id();
        ...
        $data = [
            ...
            [ 'id' => 8,   'name' => 'Jigsaw',         'full_name' => 'Jigsaw',                        'slug' => 'jigsaw',                    'abbreviation' => null,     'open_source' => 1, 'proprietary' => 0, 'owner' => null,        'website' => 'https://www.w3.org/Jigsaw/',                                  'wiki_page' => 'https://en.wikipedia.org/wiki/Hiawatha_(web_server)' ],
        ...
        App\Models\Career\DictionaryServer::insert($data);
    }
    ...
    {
        Schema::connection('career_db')->dropIfExists('dictionary_servers');
    }
};

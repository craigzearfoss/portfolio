...
return new class extends Migration
{
    ...
    {
        Schema::connection('dictionary_db')->create('operating_system_stack', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('dictionary_db')->dropIfExists('operating_system_stack');
    }
};

...
return new class extends Migration
{
    ...
    {
        Schema::connection('career_db')->create('dictionary_stacks', function (Blueprint $table) {
            $table->id();
        ...
        App\Models\Career\DictionaryStack::insert($data);
    }
    ...
    {
        Schema::connection('career_db')->dropIfExists('dictionary_stacks');
    }
};

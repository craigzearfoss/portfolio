...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $data = [
            ...
            [ 'id' => 11, 'name' => 'ounce (weight)', 'abbreviation' => 'oz (wt)', 'system' => 'imperial', 'sequence' => 9  ],
            [ 'id' => 12, 'name' => 'pound',          'abbreviation' => 'lb',      'system' => 'imperial', 'sequence' => 10  ],
            [ 'id' => 13, 'name' => 'gram',           'abbreviation' => 'g',       'system' => 'metric',   'sequence' => 11  ],
            [ 'id' => 14, 'name' => 'kilogram',       'abbreviation' => 'kg',      'system' => 'metric',   'sequence' => 12  ],
            [ 'id' => 15, 'name' => 'millilitre',     'abbreviation' => 'mL',      'system' => 'metric',   'sequence' => 13  ],
            [ 'id' => 16, 'name' => 'litre',          'abbreviation' => 'L',       'system' => 'metric',   'sequence' => 14  ],
        ];

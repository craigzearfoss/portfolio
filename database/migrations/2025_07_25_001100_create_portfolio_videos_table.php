...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $data = [
            ...
            [ 'id' => 10, 'admin_id' => 1, 'name' => 'The Woggles - Ramadan Romance',                            'slug' => 'the-woggles-ramadan-romance', 'personal' => 1, 'year' => 1998, 'company' => 'No Place Like Home Productions', 'credit' => 'Craig Zearfoss, Davis Stillson',                                                                'location' => 'Star Bar, Atlanta, GA',           'public' => 1, 'embed' => '<iframe width="560" height="315" src="https://www.youtube.com/embed/NjiOGW_wkIY?si=mLqG3hPcqm6lpEx2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>', 'link' => 'https://youtu.be/NjiOGW_wkIY?si=DLblWHZD8gGyENWC', 'link_name' => 'YouTube' ],
        ];

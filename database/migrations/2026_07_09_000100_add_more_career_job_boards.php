...
return new class extends Migration
{
    ...
    public function up(): void
    {
        $data = [
            ...
            [ 'primary' => 0, 'founded' => null, 'recruiter_id' => null, 'name' => 'Himalayas', 'slug' => 'himalayas', 'local' => 0, 'regional' => 0, 'national' => 0, 'international' => 1, 'street' => null, 'street2' => null, 'city' => 'Sydney', 'state_id' => null, 'zip' => null, 'country_id' => 14, 'link' => 'https://himalayas.app/', 'linkedin_url' => 'https://www.linkedin.com/company/himalayasapp/', 'jobs_url' => 'https://himalayas.app/jobs', 'phone' => null, 'email' => null, 'recruiter_industry_id' => 9, 'specialties' => 'remote jobs|remote work|work from home|remote job board|flexible jobs|work from home jobs|remote hiring|virtual hiring|recruiting|jobs|recruitment|job search' ],        ];

...
return new class extends Migration
{
    ...
    {
        Schema::connection('career_db')->create('dictionary_libraries', function (Blueprint $table) {
            $table->id();
        ...
        App\Models\Career\DictionaryLibrary::insert($data);
    }
    ...
    {
        Schema::connection('career_db')->dropIfExists('dictionary_libraries');
    }
};

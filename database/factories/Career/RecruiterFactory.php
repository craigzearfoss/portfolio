...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Career\Recruiter>
 */
class RecruiterFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'local'           => fake()->numberBetween(0, 1),
            'regional'        => fake()->numberBetween(0, 1),
            'national'        => fake()->numberBetween(0, 1),
            'international'   => fake()->numberBetween(0, 1),

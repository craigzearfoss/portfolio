...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('setting', [AdminSystemSettingController::class, 'show'])->name('setting.show');
    Route::get('system', [AdminSystemIndexController::class, 'index'])->name('system.index');
});

Route::prefix('admin')->middleware('admin')->name('admin.system.')->group(function () {

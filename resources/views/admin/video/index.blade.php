            ...
            <div
                ...
                <div class="h-full flex flex-auto flex-col justify-between ml-4 mr-4">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-between">
                        ...
                        <div>
                            <a class="btn btn-solid btn-sm" href="{{ route('admin.video.create') }}"><i
                                    class="fa fa-plus"></i> Add New Video</a>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <form action="{{ route('admin.video.destroy', $video->id) }}" method="POST">
                                        <a class="btn btn-sm" href="{{ route('admin.video.show', $video->id) }}"><i
                                                class="fa-solid fa-list"></i>{{-- Show--}}</a>
                                        <a class="btn btn-sm" href="{{ route('admin.video.edit', $video->id) }}"><i

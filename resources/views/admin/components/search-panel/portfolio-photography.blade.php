@php
    ...
    // set sort order
    $sort = $sort ?? request()->query('sort') ?? implode('|', [ Photography::SEARCH_ORDER_BY[0], Photography::SEARCH_ORDER_BY[1] ]);
@endphp
            ...
            <div>
                ...
                <div class="search-panel-header">
                    ...
                    @include('admin.components.search-sort-select', [
                        'sort'  => $sort,
                        'list'  => new Photography()->getSortOptions($sort, EnvTypes::ADMIN, $isRootAdmin),
                    ])
                    ...
                    <div class="floating-div">
                        ...
                        <div class="control" style="max-width: 30rem;">
                            @include('admin.components.form-checkbox', [
                                ...
                                'attributes' => [ 'data-resource' => 'portfolio.photography' ]
                            ])
                        </div>

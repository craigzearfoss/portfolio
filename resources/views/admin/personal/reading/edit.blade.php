...
@section('content')
    ...
    <div class="edit-container card form-container p-4">
        ...
        <form action="{{ route('admin.personal.reading.update', array_merge([$reading], request()->all())) }}"
            ...
            @include('admin.components.form-image-horizontal', [
                'name'      => 'thumbnail',
                'src'       => old('thumbnail') ?? $reading->thumbnail,
                'credit'    => false,
                'source'    => false,
                'maxlength' => 500,
                'message'   => $message ?? '',
            ...
            @include('admin.components.form-visibility-horizontal', [
                'public'      => old('is_public')   ?? $reading->is_public,
                'readonly'    => old('is_readonly') ?? $reading->is_readonly,
                'root'        => old('is_root')     ?? $reading->root,
                'disabled'    => old('is_disabled') ?? $reading->is_disabled,
                'demo'        => old('is_demo')     ?? $reading->is_demo,

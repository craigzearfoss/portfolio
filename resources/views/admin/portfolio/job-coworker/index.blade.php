...
@section('content')
    ...
    @include('admin.components.search-panel.portfolio-job-coworker', [ 'owner_id' => $isRootAdmin ? null : $owner->id ])
    ...
    <div class="floating-div-container" style="max-width: 80em !important;">
        ...
        <div class="show-container card floating-div">
            ...
            @include('admin.components.export-buttons-container', [
                'href'     => route('admin.portfolio.job-coworker.export', request()->except([ 'page' ])),
                'filename' => 'job_coworkers_' . date("Y-m-d-His") . '.xlsx',
            ])

            <p><i>{{ number_format($jobCoworkers->total()) }} {{ ($jobCoworkers->total() === 1) ? 'job coworker' : 'job coworkers' }} found.</i></p>
            ...
            <table class="table admin-table {{ $adminTableClasses ?? '' }}">
                ...
                @forelse ($jobCoworkers as $jobCoworker)
                    ...
                    <tr data-id="{{ $jobCoworker->id }}">
                        ...
                        <td data-field="is_public" class="has-text-centered">
                            @include('admin.components.checkmark', [ 'checked' => $jobCoworker->is_public ])
                        </td>
                        <td data-field="is_disabled" class="has-text-centered">
                            @include('admin.components.checkmark', [ 'checked' => $jobCoworker->is_disabled ])
                        </td>
                        <td class="is-1">
                ...
                @empty
                    ...
                    <tr>
                        <td colspan="{{ $isRootAdmin ? '8' : '6' }}">No job coworkers found.</td>
                    </tr>

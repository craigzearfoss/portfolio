    ...
    <div class="floating-div-container" style="max-width: 80em !important;">
        ...
        <div class="show-container card floating-div">
            ...
            @include('admin.components.export-buttons-container', [
                'href'     => route('admin.portfolio.job_coworker.export', request()->except([ 'page' ])),
            ...
            <table class="table admin-table {{ $adminTableClasses ?? '' }}">
                            ...
                            <div class="action-button-panel">
                                ...
                                @if(canDelete($jobCoworker, $admin))
                                    <form class="delete-resource"
                                          action="{!! route('admin.portfolio.job-coworker.destroy', $jobCoworker) !!}"
                                          method="POST">
                                        @csrf
                                        @method('DELETE')
                ...
                @empty
                    ...
                    <tr>
                        <td colspan="{{ $isRootAdmin ? '7' : '6' }}">No job coworkers found.</td>
                    </tr>

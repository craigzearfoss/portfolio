@php
    ...
    $breadcrumbs[] = [ 'name' => getResourcePageTitle($jobCoworker, false) ];
...
@section('content')
    ...
    <div class="floating-div-container">
        <div class="show-container card floating-div">
            ...
            @if ($isRootAdmin)
                @include('admin.components.favorites-box', [ 'label' => 'favorites', 'count' => $jobCoworker->favorite_count ])
            @endif
            ...
            @include('admin.components.show-row', [
                'name'  => 'link',
                'value' => $jobCoworker->link
                           . (!empty($jobCoworker->link)

...
@section('content')
    ...
    @include('admin.components.search-panel.portfolio-education',
        [ 'action'     => route('admin.portfolio.education.index'),
                            ...
                            <div class="action-button-panel">
                                ...
                                @if(canDelete($education, $admin))
                                    <form class="delete-resource"
                                          action="{!! route('admin.portfolio.education.destroy', $education) !!}"
                                          method="POST">
                                        @csrf
                                        @method('DELETE')

...
@section('content')
    ...
    <div class="edit-container card form-container p-4">
        ...
        <form action="{{ route('admin.portfolio.education.update', $education) }}"
              method="POST">
            @csrf
            @method('PUT')
            ...
            @include('admin.components.form-input-horizontal', [
                'name'      => 'link_name',
                'label'     => 'link name',
                'value'     => old('link_name') ?? $education->link_name,
                'maxlength' => 255,
                'message'   => $message ?? '',
            ])
            ...
            @include('admin.components.form-file-upload-horizontal', [
                'name'      => 'image',
                'value'     => old('image') ?? $education->image,
                'maxlength' => 500,
                'message'   => $message ?? '',
            ])
            ...
            @include('admin.components.form-input-horizontal', [
                'name'      => 'image_credit',
                'label'     => 'image credit',
                'value'     => old('image_credit') ?? $education->image_credit,
                'maxlength' => 255,
                'message'   => $message ?? '',
            ])
            ...
            @include('admin.components.form-input-horizontal', [
                'name'      => 'image_source',
                'label'     => 'image source',
                'value'     => old('image_source') ?? $education->image_source,
                'maxlength' => 255,
                'message'   => $message ?? '',
            ])
            ...
            @include('admin.components.form-input-horizontal', [
                'type'    => 'number',
                'name'    => 'sequence',
                'value'   => old('sequence') ?? $education->sequence,
                'min'     => 0,
                'message' => $message ?? '',
            ])
                    ...
                    <div class="field">
                        ...
                        <div class="checkbox-container card form-container p-4">
                            ...
                            @include('admin.components.form-checkbox', [
                                ...
                                'value'           => 1,
                                'unchecked_value' => 0,
                                'checked'         => old('public') ?? $education->public,
                                'message'         => $message ?? '',
                            ])
                            ...
                            @include('admin.components.form-checkbox', [
                                ...
                                'value'           => 1,
                                'unchecked_value' => 0,
                                'checked'         => old('readonly') ?? $education->readonly,
                                'message'         => $message ?? '',
                            ])
                            ...
                            @include('admin.components.form-checkbox', [
                                ...
                                'value'           => 1,
                                'unchecked_value' => 0,
                                'checked'         => old('root') ?? $education->root,
                            ...
                            @include('admin.components.form-checkbox', [
                                ...
                                'value'           => 1,
                                'unchecked_value' => 0,
                                'checked'         => old('disabled') ?? $education->disabled,
                                'message'         => $message ?? '',
                            ])

@php
    ...
    $title    = $pageTitle ?? 'Add New Project';
    $subtitle = $title;
...
@section('content')
    ...
    <div class="edit-container card form-container p-4">
        ...
        <form action="{{ route('admin.portfolio.project.store', request()->all()) }}" method="POST">
            @csrf

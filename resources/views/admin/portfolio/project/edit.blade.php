@extends('admin.layouts.default', [
    ...
    'buttons' => [
        [ 'name' => '<i class="fa fa-arrow-left"></i> Back', 'url' => $referer ?? route('admin.portfolio.project.index') ],
    ],
    ...
    <div class="card form-container p-4">
        ...
        <form action="{{ route('admin.portfolio.project.update', $project) }}" method="POST">
            ...
            @include('admin.components.form-hidden', [
                'name'  => 'referer',
                'value' => $referer ?? route('admin.portfolio.project.index')
            ])
            ...
            @if(Auth::guard('admin')->user()->root)
                @include('admin.components.form-select-horizontal', [
                    'name'    => 'admin_id',
                    'label'   => 'admin',
                    'value'   => old('admin_id') ?? $project->admin_id,
            ...
            @include('admin.components.form-input-horizontal', [
                'name'      => 'link_name',
                'label'     => 'link name',
                'value'     => old('link_name') ?? $project->link_name,
                'maxlength' => 255,
                'message'   => $message ?? '',
            ])
            ...
            @include('admin.components.form-checkbox-horizontal', [
                ...
                'value'           => 1,
                'unchecked_value' => 0,
                'checked'         => old('readonly') ?? $project->readonly,
                'message'         => $message ?? '',
            ])
            ...
            @include('admin.components.form-button-submit-horizontal', [
                'label'      => 'Save',
                'cancel_url' => $referer ?? route('admin.portfolio.project.index')
            ])

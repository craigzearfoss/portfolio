@php
    ...
    $title    = getResourcePageTitle($music);
    $subtitle = $title;
    ...
    $breadcrumbs[] = [ 'name' => getResourcePageTitle($music, false) ];
...
@section('content')
    ...
    <div class="floating-div-container">
        <div class="show-container card floating-div">
            ...
            @if ($isRootAdmin)
                @include('admin.components.favorites-box', [ 'label' => 'favorites', 'count' => $music->favorite_count ])
            @endif
            ...
            @include('admin.components.show-row', [
                'name'  => 'audio url',
                'value' => $music->audio_url
                           . (!empty($music->audio_url)

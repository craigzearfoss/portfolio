...
@section('content')
    ...
    <div class="edit-container card form-container p-4">
        ...
        <form action="{{ route('admin.portfolio.certification.update', $certification) }}"
              method="POST">
            @csrf
            @method('PUT')
            ...
            @if(isRootAdmin())
                @include('admin.components.form-select-horizontal', [
                    'name'     => 'owner_id',
                    'label'    => 'owner',
                    'value'    => old('owner_id') ?? $certification->owner_id,
                    'required' => true,
            ...
            @include('admin.components.form-checkbox-horizontal', [
                ...
                'value'           => 1,
                'unchecked_value' => 0,
                'checked'         => old('featured') ?? $certification->featured,
                'message'         => $message ?? '',
            ])

            @include('admin.components.form-input-horizontal', [
                'name'      => 'summary',
                'value'     => old('summary') ?? $certification->summary,
                'maxlength' => 500,
                'message'   => $message ?? '',
            ])
            ...
            @include('admin.components.form-input-horizontal', [
                'name'        => 'disclaimer',
                'value'       => old('disclaimer') ?? $certification->disclaimer,
                'maxlength'   => 500,
                'message'     => $message ?? '',
            ])

@php
    ...
    $title    = 'Edit ' . getResourcePageTitle($skill);
    $subtitle = $title;
    ...
    $breadcrumbs[] = [ 'name' => getResourcePageTitle($skill, false), 'href' => route('admin.portfolio.skill.show', $skill) ];
...
@section('content')
    ...
    <form action="{{ route('admin.portfolio.skill.update', array_merge([$skill], request()->all())) }}"
          class="admin-form"
          method="POST"
    >
        @csrf
            ...
            <div class="floating-div card admin-form-card">
                ...
                @if ($isRootAdmin)
                    @include('admin.components.favorites-box-form-input', [
                        'name'  => 'favorite_count',
                        'label' => 'favorites',
                        'value' => old('favorite_count') ?? $skill->favorite_count,
                    ])
                @endif
        ...
        <div class="floating-div-container">
            ...
            <div class="floating-div card admin-form-card">
                ...
                @include('admin.components.form-texttarea-horizontal', [
                    'name'      => 'disclaimer',
                ...
                @include('admin.components.form-visibility-horizontal', [
                    'is_public'   => old('is_public')   ?? $skill->is_public,
                    'is_readonly' => old('is_readonly') ?? $skill->is_readonly,
                    'is_root'     => old('is_root')     ?? $skill->root,
                    'is_disabled' => old('is_disabled') ?? $skill->is_disabled,
                    'is_demo'     => old('is_demo')     ?? $skill->is_demo,

@php
    ...
    $title    = getResourcePageTitle($publication);
    $subtitle = $title;
    ...
    $breadcrumbs[] = [ 'name' => getResourcePageTitle($publication, false) ];
...
@section('content')
    ...
    <div class="floating-div-container">
        <div class="show-container card floating-div">
            ...
            @if ($isRootAdmin)
                @include('admin.components.favorites-box', [ 'label' => 'favorites', 'count' => $publication->favorite_count ])
            @endif
            ...
            @include('admin.components.show-row', [
                'name'  => 'owner',
                'value' => $publication->owner->username,
                'hide'  => !$isRootAdmin,
            ])

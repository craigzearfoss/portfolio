@php
    ...
    $title    = getResourcePageTitle($job);
    $subtitle = $title;
    ...
    $breadcrumbs[] = [ 'name' => getResourcePageTitle($job, false) ];
                    ...
                    <div class="px-2" id="tab-content">
                        ...
                        <div id="overview">
                            ...
                            <div class="card p-4">
                                ...
                                @if ($isRootAdmin)
                                    @include('admin.components.favorites-box', [ 'label' => 'favorites', 'count' => $job->favorite_count ])
                                @endif

@php
    ...
    $title    = 'Edit ' . getResourcePageTitle($link);
    $subtitle = $title;
    ...
    $breadcrumbs[] = [ 'name' => getResourcePageTitle($link, false), 'href' => route('admin.portfolio.link.show', $link) ];
...
@section('content')
    ...
    <form action="{{ route('admin.portfolio.link.update', array_merge([$link], request()->all())) }}"
          class="admin-form"
          method="POST"
    >
        @csrf
            ...
            <div class="floating-div card admin-form-card">
                ...
                @if ($isRootAdmin)
                    @include('admin.components.favorites-box-form-input', [
                        'name'  => 'favorite_count',
                        'label' => 'favorites',
                        'value' => old('favorite_count') ?? $link->favorite_count,
                    ])
                @endif

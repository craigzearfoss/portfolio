    ...
    <div class="edit-container card form-container p-4">
        ...
        <form action="{{ route('admin.portfolio.audio.update', $audio->id) }}" method="POST">
            ...
            @include('admin.components.form-input-horizontal', [
                'name'      => 'link_name',
                'label'     => 'link name',
                'value'     => old('link_name') ?? $audio->link_name,
                'maxlength' => 255,
                'message'   => $message ?? '',
            ])
            ...
            @include('admin.components.form-input-horizontal', [
                'name'      => 'image_credit',
                'label'     => 'image credit',
                'value'     => old('image_credit') ?? $audio->image_credit,
                'maxlength' => 255,
                'message'   => $message ?? '',
            ])
            ...
            @include('admin.components.form-input-horizontal', [
                'name'      => 'image_source',
                'label'     => 'image source',
                'value'     => old('image_source') ?? $audio->image_source,
                'maxlength' => 255,
                'message'   => $message ?? '',
            ])
            ...
            @include('admin.components.form-input-horizontal', [
                'type'        => 'number',
                'name'        => 'sequence',
                'value'       => old('sequence') ?? $audio->sequence,
                'min'         => 0,
                'message'     => $message ?? '',
            ])
                    ...
                    <div class="field">
                        ...
                        <div class="checkbox-container card form-container p-4">
                            ...
                            @include('admin.components.form-checkbox', [
                                ...
                                'value'           => 1,
                                'unchecked_value' => 0,
                                'checked'         => old('public') ?? $audio->public,
                                'message'         => $message ?? '',
                            ])
                            ...
                            @include('admin.components.form-checkbox', [
                                ...
                                'value'           => 1,
                                'unchecked_value' => 0,
                                'checked'         => old('readonly') ?? $audio->readonly,
                                'message'         => $message ?? '',
                            ])
                            ...
                            @include('admin.components.form-checkbox', [
                                ...
                                'value'           => 1,
                                'unchecked_value' => 0,
                                'checked'         => old('disabled') ?? $audio->disabled,
                                'message'         => $message ?? '',
                            ])

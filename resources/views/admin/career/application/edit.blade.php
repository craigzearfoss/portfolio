        ...
        <div class="floating-div-container">
            ...
            <div class="floating-div card admin-form-card mr-2" style="width: 36rem;">
                ...
                @include('admin.components.form-job-duration-horizontal', [
                    'job_duration_type_id' => old('job_duration_type_id') ?? $application->job_duration_type_id,
                    'job_duration_length'  => old('job_duration_length') ??  $application->job_duration_length,
                    'job_duration_unit_id' => old('job_duration_unit_id') ?? $application->job_duration_unit_id,
                ])

...
``          ])
            ...
            @include('admin.components.form-input-horizontal', [
                'type'        => 'number',
                'name'        => 'sequence',
                'value'       => old('sequence') ?? $industry->sequence,
                'min'         => 0,
                'message'     => $message ?? '',
            ])
            ...
            @include('admin.components.form-checkbox-horizontal', [
                ...
                'value'           => 1,
                'unchecked_value' => 0,
                'checked'         => old('public') ?? $industry->public,
                'message'         => $message ?? '',
            ])
            ...
            @include('admin.components.form-checkbox-horizontal', [
                ...
                'checked'         => old('root') ?? $industry->root,
                'message'         => $message ?? '',
            ])
            ...
            @include('admin.components.form-checkbox-horizontal', [
                ...
                'value'           => 1,
                'unchecked_value' => 0,
                'checked'         => old('disabled') ?? $industry->disabled,
                'message'         => $message ?? '',
            ])

            @include('admin.components.form-button-submit-horizontal', [
                'label'      => 'Save',
                'cancel_url' => route('admin.career.industry.index')
            ])

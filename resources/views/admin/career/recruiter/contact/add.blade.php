...
@extends('admin.layouts.default', [
    'title'            => $pageTitle ?? 'Add a Contact to ' . $recruiter->name,
    'breadcrumbs'      => [
...
@section('content')
    ...
    <div id="contact-select" class="edit-container card form-container p-2">
        ...
        <form action="{{ route('admin.career.recruiter.contact.attach', $recruiter) }}" method="POST">
            @csrf

            @include('admin.components.form-hidden', [
                'name'  => 'referer',
                'value' => route('admin.career.recruiter.show', $recruiter)
            ])
            ...
            @include('admin.components.form-button-submit', [
                'label'      => 'Add Contact',
                'cancel_url' => referer('admin.career.recruiter.show', $recruiter)
            ])

@extends('admin.layouts.default', [
    ...
    'buttons' => [
        [ 'name' => '<i class="fa fa-arrow-left"></i> Back', 'url' => Request::header('referer') ?? route('admin.career.communication.index') ],
    ],
    'errors' => $errors ?? [],
])
        ...
        <form action="{{ route('admin.career.communication.update', $communication->id) }}"
            ...
            @if(Auth::guard('admin')->user()->root)
                @include('admin.components.form-select-horizontal', [
                    'name'    => 'admin_id',
                    'label'   => 'admin',
                    'value'   => old('admin_id') ?? $communication->admin_id,
            ...
            @include('admin.components.form-checkbox-horizontal', [
                ...
                'value'           => 1,
                'unchecked_value' => 0,
                'checked'         => old('readonly') ?? $communication->readonly,
                'message'         => $message ?? '',
            ])
            ...
            @include('admin.components.form-checkbox-horizontal', [
                ...
                'value'           => 1,
                'unchecked_value' => 0,
                'checked'         => old('root') ?? $communication->root,
            ...
            @include('admin.components.form-button-submit-horizontal', [
                'label'      => 'Save',
                'cancel_url' => Request::header('referer') ?? route('admin.career.communication.index')
            ])

                                ...
                                <div class="card-body md:p-5">
                                    <div class="text-center">
                                            ...
                                            <div class="d-grid gap-2 d-md-flex justify-between">
                                                ...
                                                <div>
                                                    <a class="btn btn-sm btn-solid"
                                                       href="{{ route('admin.reference.show', $reference) }}"><i
                                                                class="fa fa-list"></i> Show</a>
                                                    <a class="btn btn-sm btn-solid"
                                                       href="{{ route('admin.reference.index') }}"><i
                                        ...
                                        <div class="form-container">
                                            ...
                                            <form action="{{ route('admin.reference.update', $reference) }}"
                                                  method="POST">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                @include('admin.components.form-button-submit', [
                                                    'label'      => 'Save',
                                                    'cancel_url' => route('admin.career.resume.reference.index')
                                                ])

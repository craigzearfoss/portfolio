@php
    ...
    $title    = getResourcePageTitle($contact);
    $subtitle = $title;
    ...
    $breadcrumbs[] = [ 'name' => getResourcePageTitle($contact, false) ];
                    ...
                    <div class="px-2" id="tab-content">
                        ...
                        <div id="overview">
                            ...
                            <div class="card p-4">
                                ...
                                @if ($isRootAdmin)
                                    @include('admin.components.favorites-box', [ 'label' => 'favorites', 'count' => $contact->favorite_count ])
                                @endif

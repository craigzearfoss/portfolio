                                ...
                                <div class="card-body md:p-5">
                                    <div class="text-center">
                                            ...
                                            <div class="d-grid gap-2 d-md-flex justify-between">
                                                ...
                                                <div>
                                                    <a class="btn btn-sm btn-solid"
                                                       href="{{ route('admin.recipe_ingredient.show', $recipeIngredient) }}"><i
                                                                class="fa fa-list"></i> Show</a>
                                                    <a class="btn btn-sm btn-solid"
                                                       href="{{ route('admin.recipe_ingredient.index') }}"><i
                                        ...
                                        <div class="form-container">
                                            ...
                                            <form action="{{ route('admin.recipe_ingredient.update', $recipeIngredient) }}"
                                                  method="POST">
                                                @csrf
                                                @method('PUT')

...
@section('content')
    ...
    <div class="floating-div-container">
        ...
        <div class="show-container card floating-div">
            ...
            <p class="admin-table-caption"><span class="sample-color-box-light-gray"></span> indicates the user team is disabled.</p>
            ...
            <table class="table admin-table {{ $adminTableClasses ?? '' }}">
                ...
                @forelse ($userTeams as $userTeam)
                    ...
                    <tr data-id="{{ $userTeam->id }}" {!! $userTeam->is_disabled ? 'class="disabled-text"' : '' !!}>
                        @if ($isRootAdmin)
                            <td data-field="id">
                                {{ $userTeam->id }}
                            </td>
                            <td data-field="owner.username" style="white-space: nowrap;">
                                @include('admin.components.link', [
                                    ...
                                    'href' => route('admin.system.admin.show', $userTeam->owner)
                                ])
                            </td>
                        @endif
                        <td data-field="name" style="white-space: nowrap;">
                            ...
                            @include('admin.components.link-icon', [
                               ...
                               'attributes' => [ 'data-resource' => 'system.user_team', 'data-id' => $userTeam->id ]
                           ])
                        </td>

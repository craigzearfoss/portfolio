...
@section('content')
    ...
    <div class="floating-div-container">
        ...
        <div class="show-container card floating-div">
            ...
            <p><i>{{ number_format($adminGroups->total()) }} {{ $isRootAdmin ? 'admin ' : '' }}{{ ($adminGroups->total() === 1) ? 'group' : 'groups' }} found.</i></p>
                    ...
                    <tr data-id="{{ $adminGroup->id }}" {!! $adminGroup->is_disabled ? 'class="disabled-text"' : '' !!}>
                        @if ($isRootAdmin)
                            ...
                            <td data-field="owner.username" style="white-space: nowrap;">
                                @include('admin.components.link', [
                                    'name' => $adminGroup->owner->username,
                        ...
                        <td data-field="team.name" style="white-space: nowrap;">
                            ...
                            @include('admin.components.link-icon', [
                               ...
                               'attributes' => [ 'data-resource' => 'system.admin_group', 'data-id' => $adminGroup->id ]
                           ])
                        </td>

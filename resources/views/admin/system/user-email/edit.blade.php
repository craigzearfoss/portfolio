@php
    ...
    $breadcrumbs = [
        ...
        [ 'name' => isRootAdmin() ? 'User Email Numbers' : 'Email Numbers', 'href' => route('admin.system.user-email.index', ['owner_id'=>$owner->id]) ],
        [ 'name' => $adminEmail->email, 'href' => route('admin.system.user-email.show', [$adminEmail, 'owner_id'=>$owner->id]) ],
        [ 'name' => 'Edit' ]
    ];

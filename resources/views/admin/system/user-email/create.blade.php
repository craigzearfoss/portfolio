@php
    ...
    $title    = $pageTitle ?? ($isRootAdmin ? 'Add New User Email' : 'Add New Email');
    $subtitle = $title;
    ...
    $breadcrumbs = [
        ...
        [ 'name' => $isRootAdmin ? 'User Emails' : 'Email', 'href' => route('admin.system.user-email.index') ],
        [ 'name' => 'Add' ]
    ];
    ...
    <div class="edit-container card form-container p-4">
        ...
        <form action="{{ route('admin.system.user-email.store', request()->all()) }}" method="POST">
            ...
            @include('admin.components.form-button-submit-horizontal', [
                'label'      => $isRootAdmin ? 'Add User Email' : ' Add Email',

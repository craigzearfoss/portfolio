...
@section('content')
    ...
    <div class="floating-div-container">
        ...
        <div class="show-container card floating-div" style="max-width: 80em !important;">
            ...
            <p class="admin-table-caption"><span class="sample-color-box-light-gray"></span> indicates the user email is disabled.</p>
            ...
            <table class="table admin-table {{ $adminTableClasses ?? '' }}">
                ...
                @forelse ($userEmails as $userEmail)
                    ...
                    <tr data-id="{{ $userEmail->id }}" {!! $userEmail->is_disabled ? 'class="disabled-text"' : '' !!}>
                        @if ($isRootAdmin)
                            <td data-field="id">
                                {{ $userEmail->id }}
                            </td>
                        ...
                        <td data-field="email" style="white-space: nowrap;">
                            ...
                            @include('admin.components.link-icon', [
                               ...
                               'attributes' => [ 'data-resource' => 'system.user_email', 'data-id' => $userEmail->id ]
                           ])
                        </td>

...
@section('content')
    ...
    <form action="{{ route('admin.system.admin.update', array_merge([$thisAdmin], request()->all())) }}"
          class="admin-form"
          method="POST"
    >
        @csrf
            ...
            <div class="floating-div card admin-form-card">
                ...
                @if ($isRootAdmin)
                    @include('admin.components.favorites-box-form-input', [
                        'name'  => 'favorite_count',
                        'label' => 'favorites',
                        'value' => old('favorite_count') ?? $thisAdmin->favorite_count,
                    ])
                @endif
        ...
        <div class="floating-div-container">
            ...
            <div class="floating-div card admin-form-card">
                ...
                @include('admin.components.form-input-horizontal', [
                    'name'        => 'disclaimer',
                    'value'       => old('disclaimer') ?? $thisAdmin->disclaimer,
                    'maxlength'   => 500,
                    'message'     => $message ?? '',
                ])

...
@section('content')
    ...
    <div class="floating-div-container">
        <div class="show-container card floating-div">
            ...
            @if ($isRootAdmin)
                @include('admin.components.favorites-box', [ 'label' => 'favorites', 'count' => $admin->favorite_count ])
            @endif
            ...
            @include('admin.components.show-row', [
                'name'  => 'link',
                'value' => $thisAdmin->link
                           . (!empty($thisAdmin->link)
            ...
            @include('admin.components.show-row', [
                ...
                'value' => view('admin.components.disclaimer', [
                                'value' => htmlspecialchars($thisAdmin->disclaimer)
                           ])
            ])
            ...
            @include('admin.components.show-row', [
                'name'  => 'notes',
                'value' => nl2br(htmlspecialchars($thisAdmin->notes))
            ])

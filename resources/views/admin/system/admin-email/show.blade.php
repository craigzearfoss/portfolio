@php
    ...
    $title    = !$isRootAdmin
        ? str_replace('AdminEmail', 'Email', getResourcePageTitle($adminEmail))
        : getResourcePageTitle($adminEmail);
    $subtitle = $title;
...
@section('content')
    ...
    <div class="floating-div-container">
        <div class="show-container card floating-div">
            ...
            @if ($isRootAdmin)
                @include('admin.components.favorites-box', [ 'label' => 'favorites', 'count' => $adminEmail->favorite_count ])
            @endif
            ...
            @include('admin.components.show-row', [
                'name'  => 'notes',
                'value' => nl2br(htmlspecialchars($adminEmail->notes))
            ])

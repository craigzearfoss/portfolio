        ...
        <div class="flex flex-auto min-w-0">
            ...
            <div
                ...
                <div class="page-container relative h-full flex flex-auto flex-col">
                    <div class="h-full">
                        <h3 class="card-header ml-3">Edit Music</h3>
                                    ...
                                    <div class="text-center">
                                        <div class="mb-4">
                                            ...
                                            <div class="d-grid gap-2 d-md-flex justify-between">
                                                ...
                                                <div>
                                                    <a class="btn btn-sm btn-solid" href="{{ route('admin.music.show', $music) }}"><i class="fa fa-list"></i> Show</a>
                                                    <a class="btn btn-sm btn-solid" href="{{ route('admin.music.index') }}"><i class="fa fa-arrow-left"></i> Back</a>
                                                </div>
                                        ...
                                        <div class="form-container">
                                            ...
                                            <form action="{{ route('admin.music.update', $music) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                @include('admin.components.form-button-submit', [
                                                    'label'      => 'Save',
                                                    'cancel_url' => route('admin.music.index')
                                                ])

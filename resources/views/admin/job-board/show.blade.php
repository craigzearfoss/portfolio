                            ...
                            <div class="card min-w-[320px] md:min-w-[450px] max-w-[800px] card-shadow" role="presentation">
                                <div class="card-body md:p-5">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <a class="btn btn-solid btn-sm" href="{{ route('admin.job-board.edit', $jobBoard) }}"><i class="fa fa-pen-to-square"></i> Edit</a>                                        <a class="btn btn-solid btn-sm" href="{{ route('admin.job-board.index') }}"><i class="fa fa-arrow-left"></i> Back</a>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-10 pl-0">
                                                    {{ longDateTime($jobBoard->created_at) }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-10 pl-0">
                                                    {{ longDateTime($jobBoard->updated_at) }}
                                                </div>
                                            </div>
                                        </div>

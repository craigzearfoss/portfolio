            ...
            <div class="flex flex-col flex-auto min-h-screen min-w-0 relative w-full bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700">
                ...
                <div class="h-full flex flex-auto flex-col justify-between ml-4 mr-4">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-between">
                        ...
                        <div>
                            <a class="btn btn-solid btn-sm" href="{{ route('admin.link.create') }}"><i
                                        class="fa fa-plus"></i> Add New Link</a>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <form action="{{ route('admin.link.destroy', $link->id) }}" method="POST">
                                        <a class="btn btn-sm" href="{{ route('admin.link.show', $link->id) }}"><i
                                                    class="fa-solid fa-list"></i>{{-- Show--}}</a>
                                        <a class="btn btn-sm" href="{{ route('admin.link.edit', $link->id) }}"><i

@extends('admin.layouts.default', [
    ...
    'buttons' => [
        [ 'name' => '<i class="fa fa-arrow-left"></i> Back', 'url' => Request::header('referer') ?? route('admin.dictionary.database.index') ],
    ],
    ...
    <div class="card form-container p-4">
        ...
        <form action="{{ route('admin.dictionary.database.update', $database) }}" method="POST">
            ...
            @include('admin.components.form-input-horizontal', [
                'name'      => 'link_name',
                'label'     => 'link name',
                'value'     => old('link_name') ?? $database->link_name,
                'maxlength' => 255,
                'message'   => $message ?? '',
            ])
            ...
            @include('admin.components.form-input-horizontal', [
                'name'      => 'image_credit',
                'label'     => 'image credit',
                'value'     => old('image_credit') ?? $database->image_credit,
                'maxlength' => 255,
                'message'   => $message ?? '',
            ])
            ...
            @include('admin.components.form-input-horizontal', [
                'name'      => 'image_source',
                'label'     => 'image source',
                'value'     => old('image_source') ?? $database->image_source,
                'maxlength' => 255,
                'message'   => $message ?? '',
            ])

@extends('admin.layouts.default', [
    ...
    'breadcrumbs'      => [
        ...
        [ 'name' => $stack->name,      'href' => route('admin.dictionary.stack.show', $stack->id) ],
        [ 'name' => 'Edit' ],
    ],
    'buttons'          => [
...
@section('content')
    ...
    <div class="edit-container card form-container p-4">
        ...
        <form action="{{ route('admin.dictionary.stack.update', $stack) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            @include('admin.components.form-settings-horizontal', [
                'public'   => old('public') ?? $stack->public,
                'readonly' => old('readonly') ?? $stack->readonly,
                'root'     => old('root') ?? $stack->root,
                'disabled' => old('disabled') ?? $stack->disabled,
                'demo'     => old('demo') ?? $stack->demo,

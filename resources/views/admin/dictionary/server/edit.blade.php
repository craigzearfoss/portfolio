                                    ...
                                    <div class="text-center">
                                        <div class="mb-4">
                                            ...
                                            <div class="d-grid gap-2 d-md-flex justify-between">
                                                ...
                                                <div>
                                                    <a class="btn btn-sm btn-solid" href="{{ route('admin.dictionary_server.show', $dictionaryServer) }}"><i class="fa fa-list"></i> Show</a>
                                                    <a class="btn btn-sm btn-solid" href="{{ route('admin.dictionary_server.index') }}"><i class="fa fa-arrow-left"></i> Back</a>
                                                </div>
                                        ...
                                        <div class="form-container">
                                            ...
                                            <form action="{{ route('admin.dictionary_server.update', $dictionaryServer) }}" method="POST">
                                                @csrf
                                                @method('PUT')

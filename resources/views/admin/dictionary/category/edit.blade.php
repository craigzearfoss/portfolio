                                ...
                                <div class="card-body md:p-5">
                                    <div class="text-center">
                                            ...
                                            <div class="d-grid gap-2 d-md-flex justify-between">
                                                ...
                                                <div>
                                                    <a class="btn btn-sm btn-solid"
                                                       href="{{ route('admin.dictionary_category.show', $dictionaryCategory) }}"><i
                                                                class="fa fa-list"></i> Show</a>
                                                    <a class="btn btn-sm btn-solid"
                                                       href="{{ route('admin.dictionary_category.index') }}"><i
                                        ...
                                        <div class="form-container">
                                            ...
                                            <form action="{{ route('admin.dictionary_category.update', $dictionaryCategory) }}"
                                                  method="POST">
                                                @csrf
                                                @method('PUT')

        ...
        <div class="flex flex-auto min-w-0">
            ...
            <div
                ...
                <div class="page-container relative h-full flex flex-auto flex-col">
                    <div class="h-full">
                        <h3 class="card-header ml-3">Edit Dictionary Framework</h3>
                                    ...
                                    <div class="text-center">
                                        <div class="mb-4">
                                            ...
                                            <div class="d-grid gap-2 d-md-flex justify-between">
                                                ...
                                                <div>
                                                    <a class="btn btn-sm btn-solid" href="{{ route('admin.dictionary_framework.show', $dictionaryFramework) }}"><i class="fa fa-list"></i> Show</a>
                                                    <a class="btn btn-sm btn-solid" href="{{ route('admin.dictionary_framework.index') }}"><i class="fa fa-arrow-left"></i> Back</a>
                                                </div>
                                        ...
                                        <div class="form-container">
                                            ...
                                            <form action="{{ route('admin.dictionary_framework.update', $dictionaryFramework) }}" method="POST">
                                                @csrf
                                                @method('PUT')

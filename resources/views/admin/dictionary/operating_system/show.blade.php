@extends('admin.layouts.default', [
    ...
    'buttons' => [
        [ 'name' => '<i class="fa fa-pen-to-square"></i> Edit',             'url' => route('admin.dictionary_operating_system.edit', $dictionaryOperatingSystem) ],
        [ 'name' => '<i class="fa fa-plus"></i> Add New Operating Systems', 'url' => route('admin.dictionary_operating_system.create') ],

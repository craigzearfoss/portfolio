        ...
        <div class="flex flex-auto min-w-0">
            ...
            <div
                ...
                <div class="page-container relative h-full flex flex-auto flex-col">
                    <div class="h-full">
                        <h3 class="card-header ml-3">Edit Skill</h3>
                                    ...
                                    <div class="text-center">
                                        <div class="mb-4">
                                            ...
                                            <div class="d-grid gap-2 d-md-flex justify-between">
                                                ...
                                                <div>
                                                    <a class="btn btn-sm btn-solid" href="{{ route('admin.skill.show', $skill) }}"><i class="fa fa-list"></i> Show</a>
                                                    <a class="btn btn-sm btn-solid" href="{{ route('admin.skill.index') }}"><iclass="fa fa-arrow-left"></i> Back</a>
                                                </div>
                                        ...
                                        <div class="form-container">
                                            ...
                                            <form action="{{ route('admin.skill.update', $skill) }}" method="POST">
                                                ...
                                                @include('admin.components.form-button-submit', [
                                                    'label'      => 'Save',
                                                    'cancel_url' => route('admin.skill.index')
                                                ])

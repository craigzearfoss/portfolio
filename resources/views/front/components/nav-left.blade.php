                ...
                <ul>
                    ...
                    @foreach(\App\Models\Resource::where('disabled', 0)->where('public', 1)->get() as $i=>$resource)
                        ...
                        <li class="menu-collapse">
                            <a @if (strpos(Route::currentRouteName(), 'front.' . $resource->path()) !== 0)
                                   href="{{ route('front.' . $resource->path() . '.index') }}"
                                @endif
                            >
                                <div class="menu-item {{ (strpos(Route::currentRouteName(), 'front.' . $resource->path()) === 0) ? 'menu-item-active' : '' }}">
                                    <span class="text-xl">

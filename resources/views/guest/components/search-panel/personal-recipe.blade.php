        ...
        <form id="searchForm" action="{!! $action ?? '' !!}" method="get">
            ...
            <div>
                ...
                <div class="floating-div-container">
                    ...
                    <div class="floating-div">
                        <div class="search-form-control">
                            @include('guest.components.search-panel.controls.personal-recipe-type', [ 'type' => $type ])
                        </div>
                        <div class="search-form-control">
                            @include('guest.components.search-panel.controls.personal-recipe-meal', [ 'meal' => $meal ])
                        </div>
                    </div>

            ...
            <div>
                ...
                <div class="floating-div-container">
                    ...
                    <div class="floating-div">
                        ...
                        <div class="search-form-control">
                            @include('guest.components.search-panel.controls.career-resume', [ 'resume_id' => $resume_id ])
                        </div>
                    </div>

                    <div class="floating-div">
                        <div class="search-form-control">
                            @include('guest.components.search-panel.controls.career-job-duration-type', [ 'job_duration_type_id' => $job_duration_type_id ])
                        </div>
                        <div class="search-form-control">
                            @include('guest.components.search-panel.controls.career-job-employment-type', [ 'job_employment_type_id' => $job_employment_type_id ])
                        </div>
                        <div class="search-form-control">
                            @include('guest.components.search-panel.controls.career-job-location-type', [ 'job_location_type_id' => $job_location_type_id ])
                        </div>
                    </div>

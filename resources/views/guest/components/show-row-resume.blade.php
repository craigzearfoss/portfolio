@php
    ...
    if (empty($resume)) {
        abort(500, 'No $resume parameter specified in ' . base_path() . DIRECTORY_SEPARATOR . 'resource' . DIRECTORY_SEPARATOR . 'views' . DIRECTORY_SEPARATOR . 'guest' . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'show-row-resume.blade.php.');
    }

    if (empty($filetype)) {
        abort(500, 'No $filetype parameter specified in ' . base_path() . DIRECTORY_SEPARATOR . 'resource' . DIRECTORY_SEPARATOR . 'views' . DIRECTORY_SEPARATOR . 'guest' . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'show-row-resume.blade.php. Valid $filetypes are `pdf` and `doc`.');
    } elseif (!in_array($filetype, [ 'doc', 'pdf' ])) {
        abort(500, 'Invalid $filetype `' . $filetype . '` specified in ' . base_path() . DIRECTORY_SEPARATOR . 'resource' . DIRECTORY_SEPARATOR . 'views' . DIRECTORY_SEPARATOR . 'guest' . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'show-row-resume.blade.php. Valid $filetypes are `pdf` and `doc`.');
    }

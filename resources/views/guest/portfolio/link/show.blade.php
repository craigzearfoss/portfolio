@extends('guest.layouts.default', [
    ...
    'breadcrumbs'   => [
        ...
        [ 'name' => 'Links',             'href' => route('guest.portfolio.link.index', $currentAdmin) ],
        [ 'name' => $link->name ],
    ],
    'buttons'       => [
        [ 'name' => '<i class="fa fa-arrow-left"></i> Back', 'href' => referer('guest.admin.portfolio.link.index', $currentAdmin) ],
    ],

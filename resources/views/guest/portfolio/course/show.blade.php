@extends('guest.layouts.default', [
    ...
    'breadcrumbs'   => [
        ...
        [ 'name' => 'Courses',           'href' => route('guest.portfolio.course.index', $currentAdmin) ],
        [ 'name' => $course->name ],
    ],
    'buttons'       => [
        [ 'name' => '<i class="fa fa-arrow-left"></i> Back', 'href' => referer('guest.admin.portfolio.course.index', $currentAdmin) ],
    ],

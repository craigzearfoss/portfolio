            ...
            */ ?>
            ...
            @forelse ($arts as $art)
                ...
                <tr>
                    ...
                    <td class="has-text-centered">
                        @include('guest.components.checkmark', [ 'checked' => $art->public ])
                    </td>
                    <td class="has-text-centered">
                        @include('guest.components.checkmark', [ 'checked' => $art->readonly ])
                    </td>
                    <td class="has-text-centered">
                        @include('guest.components.checkmark', [ 'checked' => $art->root ])
                    </td>
                    <td class="has-text-centered">
                        @include('guest.components.checkmark', [ 'checked' => $art->disabled ])
                    </td>
                    <td class="is-1" style="white-space: nowrap;">

                        <a title="show" class="button is-small px-1 py-0"
                           href="{{ route('guest.portfolio.art.show', $art->id) }}">
                    ...
                    <table class="table table-bordered table-striped mt-4">
                        ...
                        @forelse ($arts as $art)
                            ...
                            <tr>
                                ...
                                <td class="has-text-centered">
                                    @include('guest.components.checkmark', [ 'checked' => $art->featured ])
                                </td>
                                <td>

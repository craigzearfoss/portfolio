@extends('guest.layouts.default', [
    ...
    'breadcrumbs'   => [
        ...
        [ 'name' => 'Skills',            'href' => route('guest.portfolio.skill.index', $currentAdmin) ],
        [ 'name' => $skill->name ],
    ],
    'buttons'       => [
        [ 'name' => '<i class="fa fa-arrow-left"></i> Back', 'href' => referer('guest.admin.portfolio.skill.index', $currentAdmin) ],
    ],
